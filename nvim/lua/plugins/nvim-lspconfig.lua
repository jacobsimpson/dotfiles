return function()
    ...
    -- This list is ok, and helpful even, however I'm deprecating this in favor
    -- of the `trouble` plugin, which seems to be more featureful.
    ...
    vim.api.nvim_set_keymap('n', '<space>c', '<cmd>lua vim.lsp.buf.code_action()<CR>', opts)
