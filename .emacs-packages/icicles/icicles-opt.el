...
<link rel="alternate" type="application/rss+xml"
      ...
      href="http://www.emacswiki.org/emacs?action=rss;rcidonly=icicles-opt.el" />
...
<span class="linecomment">;; Last-Updated: Fri Jun  3 15:36:58 2011 (-0700)</span>
<span class="linecomment">;;           By: dradams</span>
<span class="linecomment">;;     Update #: 4358</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;;   `cl', `el-swank-fuzzy', `ffap', `ffap-', `fuzzy', `fuzzy-match',</span>
<span class="linecomment">;;   `hexrgb', `icicles-face', `kmacro', `levenshtein', `regexp-opt',</span>
...
<span class="linecomment">;;  user options (variables).  For Icicles documentation, see</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;;    `icicle-anychar-regexp', `icicle-Completions-misc-submenu',</span>
...
<span class="linecomment">;;    `icicle-modal-cycle-up-help-keys', `icicle-no-match-hook',</span>
...
<span class="linecomment">;;    `icicle-read+insert-file-name-keys', `icicle-regexp-quote-flag',</span>
<span class="linecomment">;;    `icicle-regexp-search-ring-max', `icicle-region-background',</span>
<span class="linecomment">;;    `icicle-require-match-flag', `icicle-saved-completion-sets',</span>
<span class="linecomment">;;    `icicle-search-cleanup-flag', `icicle-search-from-isearch-keys',</span>
...
<span class="linecomment">;;    `icicle-TAB-shows-candidates-flag', `icicle-recenter',</span>
...
<span class="linecomment">;;    `icicle-buffer-sort-*...*-last',</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;;  (@&gt; "Constants used to define user options")</span>
...
<span class="linecomment">;; Emacs 20 does not DTRT wrt `:type' and `:set' sexps at compile time,</span>
<span class="linecomment">;; so there seems no way around this, short of coding without push and dolist.</span>
<span class="linecomment">;; For Emacs &lt; 21: dolist, push</span>
...
(require 'hexrgb nil t)     <span class="linecomment">;; (no error if not found): hexrgb-color-values-to-hex,</span>
                            <span class="linecomment">;; hexrgb-rgb-to-hsv, hexrgb-color-values-to-hex, hexrgb-hsv-to-rgb</span>
(require 'thingatpt)        <span class="linecomment">;; symbol-at-point, thing-at-point, thing-at-point-url-at-point</span>
(require 'thingatpt+ nil t) <span class="linecomment">;; (no error if not found): list-nearest-point-as-string,</span>
                            <span class="linecomment">;; region-or-word-nearest-point, symbol-name-nearest-point</span>
(require 'icicles-face)     <span class="linecomment">;; icicle-increment-color-hue.</span>
...
(defconst icicle-Completions-misc-submenu
    '(misc-menu
      menu-item
      "<span class="quote">Miscellaneous</span>"
      (keymap
       (complete-for-past-completion menu-item "<span class="quote">Complete for Past Completion Input</span>"
       ...
       (previous-completion-input menu-item "<span class="quote">Previous Completion Input</span>"
        icicle-retrieve-previous-input
        :visible (not (or (and icicle-C-l-uses-completion-flag (not current-prefix-arg))
                       (and (not icicle-C-l-uses-completion-flag) current-prefix-arg))))
       (next-completion-input menu-item "<span class="quote">Next Completion Input</span>"
        icicle-retrieve-next-input)
       (one-off-eval menu-item "<span class="quote">One-Off Eval...</span>"
        icicle-pp-eval-expression-in-minibuffer)
       (sep-misc "<span class="quote">--</span>")
       (icicles-help menu-item "<span class="quote">Icicles Help</span>" icicle-minibuffer-help)))
  "<span class="quote">Submenu for miscellaneous operations on completions.</span>")

<span class="linecomment">;;;###autoload</span>
(defconst icicle-Completions-save/retrieve-submenu
    '(save-retrieve-menu
      menu-item
      "<span class="quote">Save/Retrieve</span>"
      (keymap
       (save-all menu-item "<span class="quote">Save All</span>" icicle-candidate-set-save)
       (save-all-var menu-item "<span class="quote">             to Variable...</span>"
        icicle-candidate-set-save-to-variable)
       (save-all-cache menu-item "<span class="quote">             to Cache File...</span>"
        icicle-candidate-set-save-persistently)
       (add-all-to-saved menu-item "<span class="quote">Add All to Saved</span>" icicle-candidate-set-save-more)
       (save-selected menu-item "<span class="quote">Save Selected (Region) Candidates</span>"
        icicle-candidate-set-save-selected
        :enable (and mark-active (&gt; (region-end) (region-beginning))))
       (clear-saved menu-item "<span class="quote">Clear Saved Candidates</span>"
        icicle-candidate-set-save-selected
        :enable (and (boundp 'icicle-saved-completion-candidates)
                 icicle-saved-completion-candidates))
       (add-selected-to-saved menu-item "<span class="quote">Add Selected (Region) Candidates</span>"
        icicle-candidate-set-save-more-selected
        :enable (and mark-active (&gt; (region-end) (region-beginning))))
       (sep-save/retrieve-2 "<span class="quote">--</span>")
       (retrieve-saved menu-item "<span class="quote">Retrieve Saved</span>" icicle-candidate-set-retrieve
        :enable (and (boundp 'icicle-saved-completion-candidates)
                 icicle-saved-completion-candidates))
       (retrieve-more-saved menu-item "<span class="quote">Retrieve More Saved</span>"
        icicle-candidate-set-retrieve-more
        :enable (and (boundp 'icicle-saved-completion-candidates)
                 icicle-saved-completion-candidates))))
  "<span class="quote">Submenu for saving and retrieving completion candidates.</span>")

<span class="linecomment">;;;###autoload</span>
(defconst icicle-Completions-sets-submenu
    '(sets-menu
      menu-item
      "<span class="quote">Sets</span>"
      (keymap
       (complement menu-item "<span class="quote">Complement</span>" icicle-candidate-set-complement)
       (widen menu-item "<span class="quote">Or Match Alternative...</span>" icicle-widen-candidates)
       (narrow menu-item "<span class="quote">Match Also Regexp...</span>" icicle-narrow-candidates)
       (save-pred-read-var menu-item "<span class="quote">Save Predicate to Variable...  (`C-u')</span>"
        icicle-save-predicate-to-variable
        :visible current-prefix-arg)
       (save-pred-std-var menu-item "<span class="quote">Save Predicate to `icicle-input-string'</span>"
        icicle-save-predicate-to-variable
        :visible (not current-prefix-arg))
       (intersect menu-item "<span class="quote">Intersect Saved</span>" icicle-candidate-set-intersection
        :enable icicle-saved-completion-candidates)
       (difference menu-item "<span class="quote">Subtract Saved</span>" icicle-candidate-set-difference
        :enable icicle-saved-completion-candidates)
       (union menu-item "<span class="quote">Add (Union) Saved</span>" icicle-candidate-set-union
        :enable icicle-saved-completion-candidates)
       (keep-past-chrono menu-item "<span class="quote">Only Previously Entered, By Time  (`C-u')</span>"
        icicle-keep-only-past-inputs
        :visible current-prefix-arg)
       (keep-past-alpha menu-item "<span class="quote">Only Previously Entered</span>"
        icicle-keep-only-past-inputs
        :visible (not current-prefix-arg))))
  "<span class="quote">Submenu for set operations on completion candidates.</span>")

<span class="linecomment">;;;###autoload</span>
(defconst icicle-Completions-sorting-submenu
    '(sorting-menu
      menu-item
      "<span class="quote">Sorting</span>"
      (keymap
       (change-sort-order menu-item "<span class="quote">Change Sort Order</span>" icicle-change-sort-order
       ...
       (next-sort-order menu-item "<span class="quote">Next Sort Order</span>" icicle-change-sort-order
        :visible (not (or (and icicle-change-sort-order-completion-flag (not current-prefix-arg))
                       (and (not icicle-change-sort-order-completion-flag) current-prefix-arg))))
       (change-alt-sort menu-item "<span class="quote">Change Alternative Sort Order  (`M-,')</span>"
        icicle-change-alternative-sort-order
        :visible (or (and icicle-change-sort-order-completion-flag (not current-prefix-arg))
                  (and (not icicle-change-sort-order-completion-flag) current-prefix-arg)))
       (next-alt-sort menu-item "<span class="quote">Next Alternative Sort Order  (`M-,')</span>"
        icicle-change-alternative-sort-order
        :visible (not (or (and icicle-change-sort-order-completion-flag (not current-prefix-arg))
                       (and (not icicle-change-sort-order-completion-flag) current-prefix-arg))))
       (swap-sort menu-item "<span class="quote">Swap Alternative/Normal Sort</span>"
        icicle-toggle-alternative-sorting)))
  "<span class="quote">Submenu for sorting completion candidates.</span>")

<span class="linecomment">;;;###autoload</span>
(defconst icicle-Completions-this-candidate-submenu
    '(this-candidate-menu
      menu-item
      "<span class="quote">This Candidate</span>"
      (keymap
       (help-on-cand menu-item "<span class="quote">Help About</span>" icicle-help-on-candidate)
       (sep-this-1 "<span class="quote">--</span>")
       (action menu-item "<span class="quote">Act On  (`C-mouse-2')</span>" icicle-candidate-action)
       (read-fn-invoke menu-item "<span class="quote">Apply a Function To...  (`M-mouse-2')</span>"
        icicle-candidate-read-fn-invoke)
       (insert-in-minibuffer menu-item "<span class="quote">Insert in Minibuffer  (`C-insert')</span>"
        (lambda ()
          (interactive)
        ...
        :help "<span class="quote">Insert candidate in minibuffer</span>")
       (sep-this-2 "<span class="quote">--</span>")
       (all-cands menu-item "<span class="quote">Act on Each Individually</span>" icicle-all-candidates-action)
       (all-list menu-item "<span class="quote">Act on All as a List</span>" icicle-all-candidates-list-action)))
  "<span class="quote">Submenu for acting on candidate under the mouse.</span>")

<span class="linecomment">;;;###autoload</span>
(defconst icicle-Completions-toggle-submenu
    '(toggle-menu
      menu-item
      "<span class="quote">Toggle/Cycle/Change</span>"
      (keymap
       (highlighting-past menu-item "<span class="quote">Toggle Highlighting Saved Candidates</span>"
        icicle-toggle-highlight-saved-candidates)
       (highlighting-past menu-item "<span class="quote">Toggle Highlighting Past Inputs</span>"
        icicle-toggle-highlight-historical-candidates)
       (removing-dups menu-item "<span class="quote">Toggle Duplicate Removal</span>" icicle-toggle-transforming)
       (case-sensitivity menu-item "<span class="quote">Toggle Case Sensitivity  (`C-A')</span>"
        icicle-toggle-case-sensitivity)
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (regexp-quote-input menu-item "<span class="quote">Regexp-Quote Current Input</span>"
        icicle-regexp-quote-input
        :visible (not (and mark-active (&gt; (region-end) (region-beginning)))))
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (regexp-quote-region menu-item "<span class="quote">Regexp-Quote Input Region</span>"
        icicle-regexp-quote-input
        :visible (and mark-active (&gt; (region-end) (region-beginning))))
       (matching-of-newlines menu-item "<span class="quote">Toggle `.' Matching of Newlines Too</span>"
        icicle-toggle-dot)
       (literal-vs-regexp menu-item "<span class="quote">Toggle Escaping Special Regexp Chars</span>"
        icicle-toggle-regexp-quote)
       (incremental-completion menu-item "<span class="quote">Toggle Incremental Completion</span>"
        icicle-toggle-incremental-completion)
       (expanding-to-common menu-item "<span class="quote">Toggle Common Match Expansion</span>"
        icicle-toggle-expand-to-common-match)
       (hiding-common-match menu-item "<span class="quote">Toggle Hiding Common Match</span>"
        icicle-toggle-hiding-common-match)
       (oneoff-next-S-TAB menu-item "<span class="quote">ONE-OFF Next S-TAB Completion Method (`C-u')</span>"
        icicle-next-S-TAB-completion-method
        :visible current-prefix-arg)
       (next-S-TAB menu-item "<span class="quote">Next S-TAB Completion Method</span>"
        icicle-next-S-TAB-completion-method
        :visible (not current-prefix-arg))
       (oneoff-next-TAB menu-item "<span class="quote">ONE-OFF Next TAB Completion Method (`C-u')</span>"
        icicle-next-TAB-completion-method
        :visible current-prefix-arg)
       (next-TAB menu-item "<span class="quote">Next TAB Completion Method</span>"
        icicle-next-TAB-completion-method
        :visible (not current-prefix-arg))
       (next-thumbnail-setting menu-item "<span class="quote">Next Image-File Thumbnail Setting</span>"
        icicle-cycle-image-file-thumbnail)
       (proxy-candidates menu-item "<span class="quote">Toggle Including Proxy Candidates</span>"
        icicle-toggle-proxy-candidates)
       (WYSIWYG menu-item "<span class="quote">Toggle WYSIWYG for `*Completions*'</span>" icicle-toggle-WYSIWYG-Completions)
       (angle-brackets menu-item "<span class="quote">Toggle Using Angle Brackets</span>" icicle-toggle-angle-brackets)
       (ignored-files menu-item "<span class="quote">Toggle Ignored File Extensions  (`C-.')</span>"
        icicle-toggle-ignored-extensions)
       (using-C-for-actions menu-item "<span class="quote">Toggle Using `C-' for Actions</span>"
        icicle-toggle-C-for-actions)
       (using-~-for-home menu-item "<span class="quote">Toggle Using `~' for $HOME</span>"
        icicle-toggle-~-for-home-dir)
       (sep-toggle-1 "<span class="quote">--</span>")
       (search-highlight-all menu-item "<span class="quote">Toggle All-Current Search Highlighting  (`C-^')</span>"
        icicle-toggle-highlight-all-current)
       (search-whole-word menu-item "<span class="quote">Toggle Whole-Word Searching  (`M-q')</span>"
        icicle-toggle-search-whole-word)
       (search-cleanup menu-item "<span class="quote">Toggle Removal of Search Highlighting  (`C-.')</span>"
        icicle-toggle-search-cleanup)
       (search-replace-whole menu-item "<span class="quote">Toggle Replacing Whole Search Hit  (`M-_')</span>"
        icicle-toggle-search-replace-whole)
       (search-replace-common menu-item "<span class="quote">Toggle Replacing Expanded Common Match</span>"
        icicle-toggle-search-replace-common-match)
       (sep-toggle-2 "<span class="quote">--</span>")
       (option menu-item "<span class="quote">+ Toggle Option...</span>" icicle-toggle-option
        :visible (and current-prefix-arg (wholenump (prefix-numeric-value current-prefix-arg))))
       (any-var menu-item "<span class="quote">+ Toggle Any Variable...</span>" icicle-toggle-option
        :visible (and current-prefix-arg
                  (not (wholenump (prefix-numeric-value current-prefix-arg)))))
       (boolean menu-item "<span class="quote">+ Toggle Boolean Option...</span>"
        :visible (not current-prefix-arg))
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (reset-var menu-item "<span class="quote">+ Set Any Variable to `nil'...</span>" icicle-reset-option-to-nil
        :visible current-prefix-arg)
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (reset-option menu-item "<span class="quote">+ Set Option to `nil'...</span>"icicle-reset-option-to-nil
        :visible (not current-prefix-arg))
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (set-option-to-t menu-item "<span class="quote">+ Set Option to `t'...</span>" icicle-set-option-to-t
        :visible (and current-prefix-arg (wholenump (prefix-numeric-value current-prefix-arg))))
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (set-var-to-t menu-item "<span class="quote">+ Set Any Variable to `t'...</span>" icicle-set-option-to-t
        :visible (and current-prefix-arg
                  (not (wholenump (prefix-numeric-value current-prefix-arg)))))
       <span class="linecomment">;; This one is not a toggle or cycle.</span>
       (set-boolean-to-t menu-item "<span class="quote">+ Set Boolean Option to `t'...</span>" icicle-set-option-to-t
        :visible (not current-prefix-arg))))
  "<span class="quote">Submenu for toggling, cycling or changing a variable or a behavior.</span>")
...
(defcustom icicle-act-before-cycle-flag nil
  "<span class="quote">*Non-nil means act on current candidate, then cycle to next/previous.
...
(defcustom icicle-alternative-actions-alist ()
  "<span class="quote">*Alist of Emacs commands and alternative action functions.
...
that is, `M-|', but it does affect `C-|'.</span>"
  :type '(alist
          :key-type   (symbol   :tag "<span class="quote">Command</span>")
          :value-type (function :tag "<span class="quote">Alternative action (function)</span>"))
  :group 'Icicles-Miscellaneous)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-alternative-sort-comparer <span class="linecomment">; Toggle with `C-M-,'.</span>
  'icicle-historical-alphabetic-p
  "<span class="quote">*An alternative sort function, in place of `icicle-sort-comparer'.
...
<span class="linecomment">;; Must be before `icicle-dot-string'.</span>
<span class="linecomment">;;;###autoload</span>
(defconst icicle-anychar-regexp (let ((strg  (copy-sequence "<span class="quote">\\(.\\|[\n]\\)</span>")))
                                  (set-text-properties 0 (length strg)
                                                       '(display "<span class="quote">.</span>" face highlight)
                                                       strg)
                                  strg)
  "<span class="quote">Regexp that matches any single character, including newline.</span>")
...
This option has no effect if library `anything.el' cannot be loaded.</span>"
  :type 'boolean :group 'Icicles-Completions-Display :group 'Icicles-Matching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-complete-keys '([S-tab] [S-iso-lefttab]) <span class="linecomment">; `S-TAB'</span>
  <span class="linecomment">;; In Emacs 22 and later, `backtab' is the canonical key that represents both `S-tab' and</span>
  <span class="linecomment">;; `S-iso-lefttab', so in principle that could be used in the default value for Emacs 22+.</span>
  <span class="linecomment">;;</span>
  <span class="linecomment">;; In other words, the following should be sufficient:</span>
  ...
  <span class="linecomment">;;</span>
  <span class="linecomment">;; However, some Emacs 22+ libraries, such as `info.el', are brain-dead and explicitly</span>
  <span class="linecomment">;; bind both `backtab' and `S-tab'.  I filed Emacs bug #1281.</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-complete-no-display-keys '([C-M-S-tab] <span class="linecomment">; `C-M-S-TAB'</span>
                                                     [C-M-S-iso-lefttab])
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-next-keys '([next]) <span class="linecomment">; `next'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-next-action-keys '([C-next]) <span class="linecomment">; `C-next'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-next-alt-action-keys '([C-S-next]) <span class="linecomment">; `C-S-next'</span>
  "<span class="quote">*Keys for apropos completion to cycle next and perform alt action.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-next-help-keys '([(control meta next)]) <span class="linecomment">; `C-M-next'</span>
  "<span class="quote">*Keys for apropos completion to cycle next and show candidate help.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-previous-keys '([prior]) <span class="linecomment">; `prior'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-previous-action-keys '([C-prior]) <span class="linecomment">; `C-prior'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-previous-alt-action-keys '([C-S-prior]) <span class="linecomment">; `C-S-prior'</span>
  "<span class="quote">*Keys for apropos completion to cycle previous and perform alt action.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-apropos-cycle-previous-help-keys '([(control meta prior)]) <span class="linecomment">; `C-M-prior'</span>
  "<span class="quote">*Keys for apropos completion to cycle previous and show candidate help.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
arg, the name of the bookmark that is set has at most this many chars.</span>"
  :type 'integer :group 'Icicles-Miscellaneous)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-bookmark-refresh-cache-flag t
  "<span class="quote">*t means `icicle-bookmark' refreshes the bookmark-list cache.
...
use `S-delete' to delete a candidate bookmark.</span>"
  :type 'boolean :group 'Icicles-Completions-Display :group 'Icicles-Matching)
...
`icicle-must-pass-predicate'.</span>"
...
with Emacs 23) option `icicle-Completions-text-scale-decrease'.</span>"
  :type 'integer :group 'Icicles-Completions-Display)

<span class="linecomment">;; Must be before `icicle-change-region-background-flag'.</span>
<span class="linecomment">;;;###autoload</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;; NOTE: We need the `condition-case' because of a BUG in `directory-files' for Emacs 20.</span>
<span class="linecomment">;; Bug reported to `color-theme.el' maintainer 2009-11-22.  The problem is that the default value</span>
<span class="linecomment">;; of `color-theme-libraries' concats `file-name-directory', which ends in `/', with `/themes',</span>
<span class="linecomment">;; not with `themes'.  So the result is `...//themes'.  That is tolerated by Emacs 21+</span>
<span class="linecomment">;; `directory-files', but not for Emacs 20.  Until this `color-theme.el' bug is fixed, Emacs 20</span>
<span class="linecomment">;; users will need to manually load `color-theme-libraries.el'.</span>
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-color-themes ()
  "<span class="quote">*List of color themes to cycle through using `M-x icicle-color-theme'.
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-completing-read+insert-keys '([(control meta shift ?c)]) <span class="linecomment">; `C-M-S-c'</span>
  "<span class="quote">*Key sequences to invoke `icicle-completing-read+insert'.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.

Such a key has no effect unless
`icicle-completing-read+insert-candidates' is non-nil.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
removed based only on the number of input characters.</span>"
  :type 'integer :group 'Icicles-Completions-Display)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-completions-format (if (boundp 'completions-format) <span class="linecomment">; Defined in Emacs 23+.</span>
                                         completions-format
                                       'horizontal)  
  "<span class="quote">*Layout of completion candidates in buffer `*Completions*'.
...
multi-completions is always horizontal.</span>"
  :type '(choice
          (const :tag "<span class="quote">Display vertically</span>"    vertical)
          (other :tag "<span class="quote">Display horizontally</span>"  horizontal))
...
(defcustom icicle-Completions-mouse-3-menu-entries `(,icicle-Completions-this-candidate-submenu
  ...
  "<span class="quote">*Entries for the `mouse-3' popup menu in `*Completions*'.
...
Example selectable menu-item element:
 (foo menu-item \"Foo\"   foo-command
       :visible (not buffer-read-only))</span>"
  :type  '(repeat
           (choice
            <span class="linecomment">;; These could be combined, but it's better for users to see separate choices.</span>
            (restricted-sexp
             :tag "<span class="quote">Submenu (SYMBOL menu-item NAME MENU-KEYMAP . KEYWORDS) or (SYMBOL NAME . MENU-KEYMAP)</span>"
             :match-alternatives
             ((lambda (x)
                (and (consp x) (symbolp (car x))
                     (or (and (stringp (cadr x)) (cddr x)) <span class="linecomment">; (SYMBOL NAME . MENU-KEYMAP)</span>
                         <span class="linecomment">;; (SYMBOL menu-item NAME MENU-KEYMAP . KEYWORDS)</span>
                         (and (eq 'menu-item (cadr x))
                              (stringp (car (cddr x)))
                              (or (keymapp (car (cdr (cddr x)))) <span class="linecomment">; Can be a keymap var.</span>
                                  (and (symbolp (car (cdr (cddr x))))
                                       (boundp (car (cdr (cddr x))))
                                       (keymapp (symbol-value (car (cdr (cddr x)))))))))))
              'nil))
            (restricted-sexp
             :tag "<span class="quote">Items from a keymap variable's value.</span>"
             :match-alternatives ((lambda (x) (and (symbolp x) (keymapp (symbol-value x))))
                                  'nil))
            (restricted-sexp
             :tag "<span class="quote">Selectable item (SYMBOL menu-item NAME COMMAND . KEYWORDS)</span>"
             :match-alternatives ((lambda (x) (and (consp x) (symbolp (car x))
                                  ...
                                  'nil))
            (restricted-sexp
             :tag "<span class="quote">Non-selectable item (SYMBOL NAME) or (SYMBOL menu-item NAME nil . KEYWORDS)</span>"
             :match-alternatives ((lambda (x) (and (consp x) (symbolp (car x))
...
(when (fboundp 'text-scale-decrease)    <span class="linecomment">; Emacs 23+</span>
  (defcustom icicle-Completions-text-scale-decrease 0.75
    "<span class="quote">*Initial height decrease for text in buffer `*Completions*'.
...
(defcustom icicle-default-cycling-mode 'prefix
  "<span class="quote">*Default completion mode for per-mode cycling.
...
then on again, for the change to take effect in the same session.</span>"
  :type '(choice
          (const :tag "<span class="quote">Prefix cycling for per-mode keys, by default</span>"                     prefix)
          (const :tag "<span class="quote">Apropos cycling for per-mode keys, by default</span>"                    apropos)
          (const :tag "<span class="quote">No per-mode cycling - invoke completion first (`TAB', `S-TAB')</span>"   nil)
          (other :tag "<span class="quote">History cycling for per-mode keys, by default</span>"                    t))
...
(when (fboundp 'defvaralias)            <span class="linecomment">; Emacs 22+</span>
  ...
  (make-obsolete-variable 'icicle-init-value-flag 'icicle-default-value "<span class="quote">2008-04-18</span>"))
...
(defcustom icicle-dot-show-regexp-flag nil
  "<span class="quote">*Non-nil means show `icicle-anychar-regexp' explicitly for `.'.
Otherwise, display it as a highlighted `.' only.
This has no effect for Emacs versions prior to 21: acts as if non-nil.</span>"
  :type 'boolean :group 'Icicles-Matching :group 'Icicles-Minibuffer-Display)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-dot-string "<span class="quote">.</span>"
  "<span class="quote">*String inserted by `icicle-insert-dot-command'.
It is either \".\" or the value of `icicle-anychar-regexp'.
You can toggle this at any time using command `icicle-toggle-dot',
bound to \\&lt;minibuffer-local-completion-map&gt;`\\[icicle-toggle-dot]' during completion.</span>"
  :set #'(lambda (sym defs)
           (custom-set-default sym defs)
           (setq icicle-dot-string-internal  icicle-dot-string))
  :type `(choice
          (const :tag "<span class="quote">Match any char EXCEPT newline</span>"       "<span class="quote">.</span>")
          (const :tag "<span class="quote">Match any char, including NEWLINE</span>"   ,icicle-anychar-regexp))
...
(defcustom icicle-files-ido-like-flag nil
  "<span class="quote">*t means `icicle-file' and similar commands act more Ido-like.
Specifically, those commands then bind these options to t:
 `icicle-show-Completions-initially-flag'
 `icicle-top-level-when-sole-completion-flag'
 `icicle-default-value'</span>"
...
(defcustom icicle-functions-to-redefine
  '(bbdb-complete-name                   comint-dynamic-complete
    ...
    <span class="linecomment">;; Use these two if you want Icicles completion for shell commands.</span>
    <span class="linecomment">;; See http://www.emacswiki.org/emacs/Icicles_-_Shell-Command_Enhancements.</span>
    <span class="linecomment">;; </span>
    <span class="linecomment">;; dired-read-shell-command</span>
    <span class="linecomment">;; read-shell-command</span>
  ...
  "<span class="quote">*List of symbols representing functions to be redefined in Icicle mode.
...
before you enter Icicle mode.</span>"
  :type '(repeat (restricted-sexp :tag "<span class="quote">Command</span>"
                  <span class="linecomment">;; Use `symbolp' instead of `functionp' or `fboundp', in case the library</span>
                  <span class="linecomment">;; defining the function is not loaded.</span>
                  :match-alternatives (symbolp) :value ignore))
  :set #'(lambda (sym defs)
           (custom-set-default sym defs)
           (when (boundp 'icicle-mode-map) <span class="linecomment">; Avoid error on initialization.</span>
...
a prefix argument, that command also saves the cache persistently.</span>"
  :type '(choice
          (const :tag "<span class="quote">Do not add shell commands from search path</span>"              nil)
          (const :tag "<span class="quote">Compute shell commands from path when Icicles is loaded</span>" load)
          (const :tag "<span class="quote">Compute shell commands from path upon first use</span>"         first-use))
  :group 'Icicles-Miscellaneous)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-help-in-mode-line-delay 5
  "<span class="quote">*Seconds to show help in the mode-line for individual completions.
...
`icicle-expand-input-to-common-match-flag'.</span>"
  :type 'boolean :group 'Icicles-Miscellaneous)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-highlight-saved-candidates-flag t <span class="linecomment">; Toggle with `S-pause'.</span>
  "<span class="quote">*Non-nil means highlight `*Completions*' candidates that have been saved.
This is done using face `icicle-saved-candidate'.
You save candidates using, for example, `C-M-&gt;'.  You can toggle this
option from the minibuffer at any time using `S-pause'.</span>"
  :type 'boolean :group 'Icicles-Completions-Display)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-ignore-comments-flag t
  "<span class="quote">Non-nil means `icicle-with-comments-hidden' hides comments.
You can toggle this option using `C-M-;' in the minibuffer, but to see
the effect you might need to invoke the current command again.</span>"
  :type 'boolean :group 'Icicles-Searching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-ignored-directories (and (boundp 'vc-directory-exclusion-list)
                                           vc-directory-exclusion-list)
  "<span class="quote">*Directories ignored by `icicle-locate-file'.</span>"
...
(defcustom icicle-image-files-in-Completions (and (fboundp 'image-file-name-regexp)
                                                  (if (fboundp 'display-graphic-p)
                                                    ...
                                                    window-system)
                                                  t)
  "<span class="quote">*Non-nil means show thumbnail images for image files in `*Completions*'.
...
You can cycle the value during completion using `C-x t'.</span>"
  :type '(choice
          (const :tag "<span class="quote">Both name and thumbnail</span>"  t)
          (const :tag "<span class="quote">Thumbnail image only</span>"     'image-only)
          (const :tag "<span class="quote">File name only</span>"           nil))
  :group 'Icicles-Completions-Display)
...
(defcustom icicle-inhibit-advice-functions
  ...
  "<span class="quote">*Functions that Icicles redefines, and for which advice is deactivated.
Icicle mode deactivates all advice for such functions.  The advice is
reactivated when you leave Icicle mode.</span>"
  :type '(repeat (function :tag "<span class="quote">Function for which Icicles deactivates advice</span>"))
  :group 'Icicles-Miscellaneous)
...
(defcustom icicle-inter-candidates-min-spaces 1
  "<span class="quote">*Min number of spaces between candidates displayed in `*Completions*'.
If you use Do Re Mi (library `doremi.el'), then you can modify this
option incrementally during completion, seeing the effect as it
...
Emacs 23) option `icicle-Completions-text-scale-decrease'.</span>"
  :type 'integer :group 'Icicles-Completions-Display)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-isearch-complete-keys '([C-M-tab] <span class="linecomment">; `M-TAB', `C-M-TAB'</span>
                                          [M-tab] "<span class="quote">\M-\t</span>" [escape tab] <span class="linecomment">; Replace vanilla. </span>
...
during minibuffer completion.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-key-complete-keys '([S-tab] [S-iso-lefttab]) <span class="linecomment">; `S-TAB'</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-list-join-string (let ((strg  (copy-sequence "<span class="quote">\007\012</span>")))
                                     <span class="linecomment">;; Emacs 20 ignores `display', so don't bother.</span>
                                     <span class="linecomment">;; Emacs 21 has a big bug, which interprets `display' badly.</span>
                                     (when (&gt; emacs-major-version 21) <span class="linecomment">; Avoid Emacs 21 bug.</span>
...
expression, which sets text property `display' to \"\".</span>"
  :type 'string :group 'Icicles-Completions-Display)
...
(defcustom icicle-max-candidates nil
  "<span class="quote">*Non-nil means truncate completion candidates to at most this many.
...
resets `icicle-max-candidates' to nil, meaning no truncation.</span>"
  :type '(choice (const :tag "<span class="quote">None</span>" nil) integer)
...
(defcustom icicle-menu-items-to-history-flag t
  "<span class="quote">*Non-nil means to add menu-item commands to the command history.
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-down-keys <span class="linecomment">; `down', `wheel-down'</span>
  (if (boundp 'mouse-wheel-down-event)  <span class="linecomment">; Emacs 22+</span>
      (list
       [down]
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-down-action-keys <span class="linecomment">; `C-down', `C-wheel-down'</span>
  (if (boundp 'mouse-wheel-up-event)    <span class="linecomment">; Emacs 22+</span>
      (list
       [C-down]
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-down-alt-action-keys <span class="linecomment">; `C-S-down', `C-S-wheel-down'</span>
  (if (boundp 'mouse-wheel-up-event)    <span class="linecomment">;Emacs22+</span>
      (list
       [C-S-down]
       ...
       (vector (list 'control 'shift
                     mouse-wheel-up-event)))
    '([C-S-down]))
  "<span class="quote">*Keys for modal completion to cycle next and perform alt action.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-down-help-keys <span class="linecomment">; `C-M-down', `C-M-wheel-down'</span>
  (if (boundp 'mouse-wheel-up-event)    <span class="linecomment">; Emacs 22+</span>
      (list
       [(control meta down)]
       ...
       (vector (list 'control 'meta
                     mouse-wheel-up-event)))
    '([(control meta down)]))
  "<span class="quote">*Keys for modal completion to cycle next and show candidate help.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-up-keys   <span class="linecomment">; `up', `wheel-up'</span>
  (if (boundp 'mouse-wheel-down-event)  <span class="linecomment">; Emacs 22+</span>
      (list
       [up]
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-up-action-keys <span class="linecomment">; `C-up', `C-wheel-up'</span>
  (if (boundp 'mouse-wheel-down-event)  <span class="linecomment">; Emacs 22+</span>
      (list
       [C-up]
       (vector nil (list 'control
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-up-alt-action-keys <span class="linecomment">; `C-S-up', `C-S-wheel-up'</span>
  (if (boundp 'mouse-wheel-down-event)  <span class="linecomment">; Emacs 22+</span>
      (list
       [C-S-up]
       (vector nil (list 'control 'shift
       ...
       (vector (list 'control 'shift
                     mouse-wheel-down-event)))
    '([C-S-up]))
  "<span class="quote">*Keys for modal completion to cycle previous and perform alt action.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-modal-cycle-up-help-keys <span class="linecomment">; `C-M-up', `C-M-wheel-up'</span>
  (if (boundp 'mouse-wheel-down-event)  <span class="linecomment">; Emacs 22+</span>
      (list
       [(control meta up)]
       (vector nil (list 'control 'meta
       ...
       (vector (list 'control 'meta
                     mouse-wheel-down-event)))
    '([(control meta up)]))
  "<span class="quote">*Keys for modal completion to cycle previous and show candidate help.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
(defcustom icicle-no-match-hook nil
  "<span class="quote">*List of hook functions run during completion when there are no matches.</span>"
  :type 'hook :group 'Icicles-Miscellaneous)
...
(when (&gt; emacs-major-version 22)
  (defcustom icicle-populate-interactive-history-flag nil
    "<span class="quote">*Non-nil means populate `icicle-interactive-history'.
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-complete-keys '([tab] [(control ?i)]) <span class="linecomment">; `C-i' is `TAB'.</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-complete-no-display-keys '([(control meta tab)]) <span class="linecomment">; `C-M-TAB'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-next-keys '([end]) <span class="linecomment">; `end'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-next-action-keys '([C-end]) <span class="linecomment">; `C-end'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-next-alt-action-keys '([C-S-end]) <span class="linecomment">; `C-S-end'</span>
  "<span class="quote">*Keys for prefix completion to cycle next and perform alt action.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-next-help-keys '([(control meta end)]) <span class="linecomment">; `C-M-end'</span>
  "<span class="quote">*Keys for prefix completion to cycle next and show candidate help.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-previous-keys '([home]) <span class="linecomment">; `home'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-previous-action-keys '([C-home]) <span class="linecomment">; `C-home'</span>
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-previous-alt-action-keys '([C-S-home]) <span class="linecomment">; `C-S-home'</span>
  "<span class="quote">*Keys for prefix completion to cycle previous and perform alt action.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-prefix-cycle-previous-help-keys '([(control meta home)]) <span class="linecomment">; `C-M-home'</span>
  "<span class="quote">*Keys for prefix completion to cycle previous and show candidate help.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-previous-candidate-keys '([S-tab] [S-iso-lefttab]) <span class="linecomment">; `S-TAB'</span>
  <span class="linecomment">;; $$$$$ The following should be sufficient, but some Emacs 22+ libraries, such as `info.el',</span>
  <span class="linecomment">;; are brain-dead and explicitly bind both `backtab' and `S-tab'.  I filed Emacs bug #1281.</span>
  <span class="linecomment">;;   (if (&gt; emacs-major-version 21)</span>
  <span class="linecomment">;;       '([backtab])</span>
...
(defcustom icicle-quote-shell-file-name-flag t
  "<span class="quote">*Non-nil means to double-quote the file name that starts a shell command.
...
information about the characters that, like SPC, lead to quoting.</span>"
  :type 'boolean :group 'Icicles-Miscellaneous)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-read+insert-file-name-keys '([(control meta shift ?f)]) <span class="linecomment">; `C-M-S-f'</span>
  "<span class="quote">*Key sequences to invoke `icicle-read+insert-file-name'.
A list of values that each has the same form as a key-sequence
argument to `define-key'.  It is a list mainly in order to accommodate
different keyboards.</span>"
  :type '(repeat sexp) :group 'Icicles-Key-Bindings)
...
<span class="linecomment">;; Must be before `icicle-region-background'.</span>
...
(defcustom icicle-region-background
  (if (featurep 'hexrgb)
      (let* ((bg   (or (and (boundp '1on1-active-minibuffer-frame-background)
                       ...
                       (let ((frame-bg  (cdr (assq 'background-color (frame-parameters)))))
                         (when (member frame-bg '(nil unspecified "<span class="quote">unspecified-bg</span>"))
                           (setq frame-bg  (if (eq (frame-parameter nil 'background-mode) 'dark)
                                               "<span class="quote">Black</span>"
        ...
        (if sat
            (if (hexrgb-approx-equal sat 0.0)
                (icicle-increment-color-value
                 bg                     <span class="linecomment">; Grayscale - change bg value slightly.</span>
  ...
  "<span class="quote">*Background color to use for the region during minibuffer cycling.
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-search-from-isearch-keys '([S-tab] [S-iso-lefttab]) <span class="linecomment">; `S-TAB'</span>
  <span class="linecomment">;; $$$$$ The following should be sufficient, but some Emacs 22+ libraries, such as `info.el',</span>
  <span class="linecomment">;; are brain-dead and explicitly bind both `backtab' and `S-tab'.  I filed Emacs bug #1281.</span>
  <span class="linecomment">;;   (if (&gt; emacs-major-version 21)</span>
  <span class="linecomment">;;       '([backtab])</span>
...
(defcustom icicle-search-hook nil
  "<span class="quote">*List of functions run by `icicle-search' after you visit a search hit.
See `run-hooks'.</span>"
  :type 'hook :group 'Icicles-Searching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-search-replace-common-match-flag t <span class="linecomment">; Toggle with `M-;'.</span>
...
`icicle-search-replace-common-match-flag' using `M-;'.</span>"
  :type 'boolean :group 'Icicles-Searching)
...
<span class="linecomment">;; Must be before `icicle-shell-command-candidates-cache'.</span>
(defun icicle-compute-shell-command-candidates ()
  "<span class="quote">Compute shell command candidates from search path, and return them.
...
`shell-completion-execonly' is nil, all files in your search path.</span>"
  ...
  (message "<span class="quote">Finding commands in search path...</span>")
  (let* ((filenondir         "<span class="quote"></span>")
         ...
         (completions        ()))
    <span class="linecomment">;; Go through each dir in the search path, finding completions.</span>
    (while path-dirs
      (setq dir           (file-name-as-directory (comint-directory (or (car path-dirs) "<span class="quote">.</span>")))
            comps-in-dir  (and (file-accessible-directory-p dir)
                               (file-name-all-completions filenondir dir)))
      <span class="linecomment">;; Go  see whether it should be used.</span>
      (while comps-in-dir
...
delete input, but not initially.</span>"
  :type 'boolean :group 'Icicles-Completions-Display)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-show-multi-completion-flag t
  "<span class="quote">*Non-nil means to show completion candidates as multi-completions.
...
<span class="linecomment">;; This is similar to `bmkp-sort-comparer'.</span>
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-sort-comparer 'icicle-case-string-less-p <span class="linecomment">; Cycle with `C-,'.</span>
  "<span class="quote">*Predicate or predicates for sorting (comparing) two items.
...
have the suffix `-cp' (for \"component predicate\") instead of `-p'.</span>"
  <span class="linecomment">;; We don't bother to define a `icicle-reverse-multi-sort-order'</span>
  <span class="linecomment">;; analogous to `bmkp-reverse-multi-sort-order'.  If we did, the doc</span>
  <span class="linecomment">;; string would need to be updated to say what the doc string of</span>
  <span class="linecomment">;; `bmkp-sort-comparer' says about `bmkp-reverse-multi-sort-order'.</span>
  :type '(choice
          (const    :tag "<span class="quote">None (do not sort)</span>" nil)
          (function :tag "<span class="quote">Sorting Predicate</span>")
          (list     :tag "<span class="quote">Sorting Multi-Predicate</span>"
           (repeat (function :tag "<span class="quote">Component Predicate</span>"))
           (choice
            (const    :tag "<span class="quote">None</span>" nil)
            (function :tag "<span class="quote">Final Predicate</span>"))))
  :group 'Icicles-Matching :group 'Icicles-Completions-Display)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-buffer-configs
  `(("<span class="quote">All</span>" nil nil nil nil ,icicle-sort-comparer)
    ...
    ("<span class="quote">Files and Scratch</span>" nil nil (lambda (bufname) (buffer-file-name (get-buffer bufname)))
     ("<span class="quote">*scratch*</span>") ,icicle-sort-comparer)
...
(when (&gt; emacs-major-version 20)
  (defcustom icicle-sort-orders-alist ()
    "<span class="quote">*Alist of available sort functions.
...
(unless (&gt; emacs-major-version 20)      <span class="linecomment">; Emacs 20: custom type `alist' doesn't exist.</span>
  (defcustom icicle-sort-orders-alist ()
    "<span class="quote">*Alist of available sort functions.
This is a pseudo option - you probably do NOT want to customize this.
Instead, use macro `icicle-define-sort-command' to define a new sort
...
Each alist element has the form (SORT-ORDER . COMPARER):
 ...
 `icicle-sort-comparer'.</span>"
    :type '(repeat
            (cons
             (choice :tag "<span class="quote">Sort order</span>" string symbol)
             (choice
              (const    :tag "<span class="quote">None (do not sort)</span>" nil)
              (function :tag "<span class="quote">Sorting Predicate</span>")
              (list     :tag "<span class="quote">Sorting Multi-Predicate</span>"
...
<span class="linecomment">;;;###autoload</span>
(defcustom icicle-S-TAB-completion-methods-alist <span class="linecomment">; Cycle with `M-('.</span>
  `(("<span class="quote">apropos</span>" . string-match)
    ("<span class="quote">scatter</span>" . icicle-scatter-match)
    ,@(and (require 'fuzzy nil t)       <span class="linecomment">; `fuzzy.el', part of library Autocomplete.</span>
           '(("<span class="quote">Jaro-Winkler</span>" . fuzzy-match)))
  ...
  "<span class="quote">*Alist of completion methods used by `S-TAB'.
...
`icicle-S-TAB-completion-methods-per-command'.</span>"
  :type '(alist
          :key-type   (string :tag "<span class="quote">Name used in messages</span>")
          :value-type (symbol :tag "<span class="quote">Completion matching function</span>"))
  :group 'Icicles-Matching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-S-TAB-completion-methods-per-command ()
  "<span class="quote">*Alist of commands and their available S-TAB completion methods.
...
prefix argument (or else start a new Emacs session).</span>"
  :type (let ((methods  ()))
          (when (require 'levenshtein nil t)
            (push '(const :tag "<span class="quote">Levenshtein strict</span>"
                    ("<span class="quote">Levenshtein strict</span>" . icicle-levenshtein-strict-match))
                  methods)
            (push '(const :tag "<span class="quote">Levenshtein</span>" ("<span class="quote">Levenshtein</span>" . icicle-levenshtein-match))
                  methods))
          (when (require 'fuzzy nil t) <span class="linecomment">; `fuzzy.el', part of library Autocomplete.</span>
            (push '(const :tag "<span class="quote">Jaro-Winkler</span>" ("<span class="quote">Jaro-Winkler</span>" . fuzzy-match)) methods))
          (push '(const :tag "<span class="quote">scatter</span>" ("<span class="quote">scatter</span>" . icicle-scatter-match)) methods)
          (push '(const :tag "<span class="quote">apropos</span>" ("<span class="quote">apropos</span>" . string-match)) methods)
          `(alist
            :key-type   (restricted-sexp
                         :tag "<span class="quote">Command</span>"
                         <span class="linecomment">;; Use `symbolp' instead of `commandp', in case the library</span>
                         <span class="linecomment">;; defining the command is not yet loaded.</span>
                         :match-alternatives (symbolp) :value ignore)
            :value-type (repeat :tag "<span class="quote">S-TAB completion methods</span>" (choice ,@methods))))
  :set #'(lambda (sym val)
...
(defcustom icicle-swank-prefix-length 1
  "<span class="quote">*Length (chars) of symbol prefix that much match, for swank completion.</span>"
  :type 'integer :group 'Icicles-Matching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-swank-timeout 3000
  "<span class="quote">*Number of msec before swank (fuzzy symbol) completion gives up.</span>"
  :type 'integer :group 'Icicles-Matching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-TAB-completion-methods <span class="linecomment">; Cycle with `C-('.</span>
  (let ((methods  ()))
    ...
    (push 'basic methods)
    methods)
  "<span class="quote">*List of completion methods to use for \
...
`icicle-S-TAB-completion-methods-alist'.</span>"
  :type (let ((methods  ()))
          (when (require 'el-swank-fuzzy nil t)
            (push '(const :tag "<span class="quote">Swank (Fuzzy Symbol)</span>" swank) methods))
          (when (require 'fuzzy-match nil t)
            (push '(const :tag "<span class="quote">Fuzzy</span>" fuzzy) methods))
          (when (boundp 'completion-styles)
            (push '(const :tag "<span class="quote">Vanilla `completion-styles'</span>" vanilla) methods))
          (push '(const :tag "<span class="quote">Basic</span>" basic) methods)
          `(repeat (choice ,@methods)))
  :group 'Icicles-Matching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-TAB-completion-methods-per-command ()
  "<span class="quote">*Alist of commands and their available TAB completion methods.
  ...
  :type (let ((methods  ()))
          ...
          `(alist
            :key-type   (restricted-sexp
                         ...
                         <span class="linecomment">;; defining the command is not yet loaded.</span>
                         :match-alternatives (symbolp) :value ignore)
            :value-type (repeat :tag "<span class="quote">TAB completion methods</span>" (choice ,@methods))))
  :set #'(lambda (sym val)
           (custom-set-default sym val)
...
(defcustom icicle-recenter -4
  "<span class="quote">Argument passed to `recenter' to recenter point in the target window.
Used during functions such as `icicle-search' when the destination to
visit would otherwise be off-screen.</span>"
  :type '(choice
	  (const   :tag "<span class="quote">To mid-window</span>" nil)
	  (integer :tag "<span class="quote">On this line number (negative: from bottom)</span>" nil))
  :group 'Icicles-Miscellaneous)
...
(defcustom icicle-thing-at-point-functions
  (progn (or (require 'ffap- nil t) (require 'ffap nil t)) <span class="linecomment">; Try `ffap-.el' first.</span>
         (cons
          <span class="linecomment">;; 1) Lisp symbol or file name, 2) region-or-word, 3) Ffap, 4)url.</span>
...
<span class="linecomment">;; Must be before `icicle-top-level-key-bindings'.</span>
<span class="linecomment">;;;###autoload</span>
...
(defcustom icicle-top-level-key-bindings
  `((,(kbd "<span class="quote">&lt;pause&gt;</span>") icicle-switch-to/from-minibuffer    t) <span class="linecomment">; `pause'</span>
    ...
    (bookmark-jump                  icicle-bookmark                    t) <span class="linecomment">; `C-x r b'</span>
    (bookmark-jump-other-window     icicle-bookmark-other-window       t) <span class="linecomment">; `C-x 4 j j'</span>
    ...
    (dired                          icicle-dired                       t) <span class="linecomment">; `C-x d'</span>
    (dired-other-window             icicle-dired-other-window          t) <span class="linecomment">; `C-x 4 d'</span>
    ...
    (find-file-read-only            icicle-find-file-read-only         t) <span class="linecomment">; `C-x C-r'</span>
    (find-file-read-only-other-window
     icicle-find-file-read-only-other-window                           t) <span class="linecomment">; `C-x 4 r'</span>
    <span class="linecomment">;; There are no key bindings in vanilla Emacs for `insert-buffer'.</span>
    <span class="linecomment">;; If you use `setup-keys.el', then these are its bindings: `C-S-insert', `M-S-f1'.</span>
    ...
    <span class="linecomment">;; These are available only if you use library `bookmark+.el'.</span>
    <span class="linecomment">;;</span>
    (bmkp-tag-a-file
     icicle-tag-a-file   (fboundp 'bmkp-tag-a-file))                           <span class="linecomment">; `C-x p t + a'</span>
    (bmkp-untag-a-file
     icicle-untag-a-file (fboundp 'bmkp-untag-a-file))                         <span class="linecomment">; `C-x p t - a'</span>
    (bmkp-find-file-all-tags
     icicle-find-file-all-tags (fboundp 'bmkp-find-file-all-tags))             <span class="linecomment">; `C-x j t a *'</span>
    (bmkp-find-file-all-tags-other-window
     icicle-find-file-all-tags-other-window
     (fboundp 'bmkp-find-file-all-tags))                                       <span class="linecomment">; `C-x 4 j t a *'</span>
    (bmkp-find-file-all-tags-regexp
     icicle-find-file-all-tags-regexp
     (fboundp 'bmkp-find-file-all-tags-regexp))                                <span class="linecomment">; `C-x j t a % *'</span>
    (bmkp-find-file-all-tags-regexp-other-window
     icicle-find-file-all-tags-regexp-other-window
     (fboundp 'bmkp-find-file-all-tags-regexp-other-window))                   <span class="linecomment">; `C-x 4 j t a % *'</span>
    (bmkp-find-file-some-tags
     icicle-find-file-some-tags (fboundp 'bmkp-find-file-some-tags))           <span class="linecomment">; `C-x j t a +'</span>
    (bmkp-find-file-some-tags-other-window
     icicle-find-file-some-tags-other-window
     (fboundp 'bmkp-find-file-some-tags-other-window))                         <span class="linecomment">; `C-x 4 j t a +'</span>
    (bmkp-find-file-some-tags-regexp
     icicle-find-file-some-tags-regexp
     (fboundp 'bmkp-find-file-some-tags-regexp))                               <span class="linecomment">; `C-x j t a % +'</span>
    (bmkp-find-file-some-tags-regexp-other-window
     icicle-find-file-some-tags-regexp-other-window
     (fboundp 'bmkp-find-file-some-tags-regexp-other-window))                  <span class="linecomment">; `C-x 4 j t a % +'</span>
    <span class="linecomment">;;   (Other-window means nothing for a bookmark list or a desktop.)</span>
    (bmkp-bookmark-list-jump
     icicle-bookmark-bookmark-list (fboundp 'bmkp-bookmark-list-jump))         <span class="linecomment">; `C-x j B'</span>
    (bmkp-desktop-jump
     icicle-bookmark-desktop (fboundp 'bmkp-desktop-jump))                     <span class="linecomment">; `C-x j K'</span>
    (bmkp-dired-jump
     icicle-bookmark-dired (fboundp 'bmkp-dired-jump))                         <span class="linecomment">; `C-x j d'</span>
    (bmkp-dired-jump-other-window
     icicle-bookmark-dired-other-window (fboundp 'bmkp-dired-jump))            <span class="linecomment">; `C-x 4 j d'</span>
    (bmkp-file-jump
     icicle-bookmark-file (fboundp 'bmkp-file-jump))                           <span class="linecomment">; `C-x j f'</span>
    (bmkp-file-jump-other-window
     icicle-bookmark-file-other-window (fboundp 'bmkp-file-jump))              <span class="linecomment">; `C-x 4 j f'</span>
    (bmkp-file-this-dir-jump
     icicle-bookmark-file-this-dir (fboundp 'bmkp-file-this-dir-jump))         <span class="linecomment">; `C-x j C-f'</span>
    (bmkp-file-this-dir-jump-other-window
     icicle-bookmark-file-this-dir-other-window (fboundp 'bmkp-file-this-dir-jump)) <span class="linecomment">; `C-x 4 j C-f'</span>
    (bmkp-gnus-jump
     icicle-bookmark-gnus (fboundp 'bmkp-gnus-jump))                           <span class="linecomment">; `C-x j g'</span>
    (bmkp-gnus-jump-other-window
     icicle-bookmark-gnus-other-window (fboundp 'bmkp-gnus-jump))              <span class="linecomment">; `C-x 4 j g'</span>
    (bmkp-info-jump
     icicle-bookmark-info (fboundp 'bmkp-info-jump))                           <span class="linecomment">; `C-x j i'</span>
    (bmkp-info-jump-other-window
     icicle-bookmark-info-other-window (fboundp 'bmkp-info-jump))              <span class="linecomment">; `C-x 4 j i'</span>
    (bmkp-local-file-jump
     icicle-bookmark-local-file (fboundp 'bmkp-local-file-jump))               <span class="linecomment">; `C-x j l'</span>
    (bmkp-local-file-jump-other-window
     icicle-bookmark-local-file-other-window (fboundp 'bmkp-local-file-jump))  <span class="linecomment">; `C-x 4 j l'</span>
    (bmkp-man-jump
     icicle-bookmark-man  (fboundp 'bmkp-man-jump))                            <span class="linecomment">; `C-x j m'</span>
    (bmkp-man-jump-other-window
     icicle-bookmark-man-other-window  (fboundp 'bmkp-man-jump))               <span class="linecomment">; `C-x 4 j m'</span>
    (bmkp-non-file-jump
     icicle-bookmark-non-file (fboundp 'bmkp-non-file-jump))                   <span class="linecomment">; `C-x j b'</span>
    (bmkp-non-file-jump-other-window
     icicle-bookmark-non-file-other-window (fboundp 'bmkp-non-file-jump))      <span class="linecomment">; `C-x 4 j b'</span>
    (bmkp-region-jump
     icicle-bookmark-region (fboundp 'bmkp-region-jump))                       <span class="linecomment">; `C-x j r'</span>
    (bmkp-region-jump-other-window
     icicle-bookmark-region-other-window (fboundp 'bmkp-region-jump))          <span class="linecomment">; `C-x 4 j r'</span>
    (bmkp-remote-file-jump
     icicle-bookmark-remote-file (fboundp 'bmkp-remote-file-jump))             <span class="linecomment">; `C-x j n'</span>
    (bmkp-remote-file-jump-other-window
     icicle-bookmark-remote-file-other-window (fboundp 'bmkp-remote-file-jump)) <span class="linecomment">; `C-x 4 j n'</span>
    (bmkp-specific-buffers-jump
     icicle-bookmark-specific-buffers (fboundp 'bmkp-specific-buffers-jump))   <span class="linecomment">; `C-x j = b'</span>
    (bmkp-specific-buffers-jump-other-window
     icicle-bookmark-specific-buffers-other-window (fboundp 'bmkp-specific-buffers-jump)) <span class="linecomment">; `C-x 4 j = b'</span>
    (bmkp-specific-files-jump
     icicle-bookmark-specific-files (fboundp 'bmkp-specific-files-jump))       <span class="linecomment">; `C-x j = f'</span>
    (bmkp-specific-files-jump-other-window
     icicle-bookmark-specific-files-other-window (fboundp 'bmkp-specific-files-jump)) <span class="linecomment">; `C-x 4 j = f'</span>
    (bmkp-this-buffer-jump
     icicle-bookmark-this-buffer (fboundp 'bmkp-this-buffer-jump))             <span class="linecomment">; `C-x j .'</span>
    (bmkp-this-buffer-jump-other-window
     icicle-bookmark-this-buffer-other-window (fboundp 'bmkp-this-buffer-jump)) <span class="linecomment">; `C-x 4 j .'</span>
    (bmkp-all-tags-jump
     icicle-bookmark-all-tags (fboundp 'bmkp-all-tags-jump))                   <span class="linecomment">; `C-x j t *'</span>
    (bmkp-all-tags-jump-other-window
     icicle-bookmark-all-tags-other-window (fboundp 'bmkp-all-tags-jump))      <span class="linecomment">; `C-x 4 j t *'</span>
    (bmkp-all-tags-regexp-jump
     icicle-bookmark-all-tags-regexp (fboundp 'bmkp-all-tags-regexp-jump))     <span class="linecomment">; `C-x j t % *'</span>
    (bmkp-all-tags-regexp-jump-other-window
     icicle-bookmark-all-tags-regexp-other-window (fboundp 'bmkp-all-tags-regexp-jump)) <span class="linecomment">; `C-x 4 j t % *'</span>
    (bmkp-some-tags-jump
     icicle-bookmark-some-tags (fboundp 'bmkp-some-tags-jump))                 <span class="linecomment">; `C-x j t +'</span>
    (bmkp-some-tags-jump-other-window
     icicle-bookmark-some-tags-other-window (fboundp 'bmkp-some-tags-jump))    <span class="linecomment">; `C-x 4 j t +'</span>
    (bmkp-some-tags-regexp-jump
     icicle-bookmark-some-tags-regexp (fboundp 'bmkp-some-tags-regexp-jump))   <span class="linecomment">; `C-x j t % +'</span>
    (bmkp-some-tags-regexp-jump-other-window
     icicle-bookmark-some-tags-regexp-other-window
     (fboundp 'bmkp-some-tags-regexp-jump))                                    <span class="linecomment">; `C-x 4 j t % +'</span>
    (bmkp-file-all-tags-jump
     icicle-bookmark-file-all-tags (fboundp 'bmkp-file-all-tags-jump))         <span class="linecomment">; `C-x j t f *'</span>
    (bmkp-file-all-tags-jump-other-window
     icicle-bookmark-file-all-tags-other-window (fboundp 'bmkp-file-all-tags-jump)) <span class="linecomment">; `C-x 4 j t f *'</span>
    (bmkp-file-all-tags-regexp-jump
     icicle-bookmark-file-all-tags-regexp (fboundp 'bmkp-file-all-tags-regexp-jump)) <span class="linecomment">; `C-x j t f % *'</span>
    (bmkp-file-all-tags-regexp-jump-other-window
     icicle-bookmark-file-all-tags-regexp-other-window
     (fboundp 'bmkp-file-all-tags-regexp-jump))                                <span class="linecomment">; `C-x 4 j t f % *'</span>
    (bmkp-file-some-tags-jump
     icicle-bookmark-file-some-tags (fboundp 'bmkp-file-some-tags-jump))       <span class="linecomment">; `C-x j t f +'</span>
    (bmkp-file-some-tags-jump-other-window
     icicle-bookmark-file-some-tags-other-window (fboundp 'bmkp-file-some-tags-jump)) <span class="linecomment">; `C-x 4 j t f +'</span>
    (bmkp-file-some-tags-regexp-jump
     icicle-bookmark-file-some-tags-regexp (fboundp 'bmkp-file-some-tags-regexp-jump)) <span class="linecomment">; `C-x j t f % +'</span>
    (bmkp-file-some-tags-regexp-jump-other-window
     icicle-bookmark-file-some-tags-regexp-other-window
     (fboundp 'bmkp-file-some-tags-regexp-jump))                               <span class="linecomment">; `C-x 4 j t f % +'</span>
    (bmkp-file-this-dir-all-tags-jump
     icicle-bookmark-file-this-dir-all-tags <span class="linecomment">; `C-x j t C-f *'</span>
     (fboundp 'bmkp-file-this-dir-all-tags-jump))
    (bmkp-file-this-dir-all-tags-jump-other-window
     icicle-bookmark-file-this-dir-all-tags-other-window <span class="linecomment">; `C-x 4 j t C-f *'</span>
     (fboundp 'bmkp-file-this-dir-all-tags-jump))
    (bmkp-file-this-dir-all-tags-regexp-jump
     icicle-bookmark-file-this-dir-all-tags-regexp <span class="linecomment">; `C-x j t % C-f *'</span>
     (fboundp 'bmkp-file-this-dir-all-tags-regexp-jump))
    (bmkp-file-this-dir-all-tags-regexp-jump-other-window
     icicle-bookmark-file-this-dir-all-tags-regexp-other-window <span class="linecomment">; `C-x 4 j t % C-f *'</span>
     (fboundp 'bmkp-file-this-dir-all-tags-regexp-jump))
    (bmkp-file-this-dir-some-tags-jump
     icicle-bookmark-file-this-dir-some-tags <span class="linecomment">; `C-x j t C-f +'</span>
     (fboundp 'bmkp-file-this-dir-some-tags-jump))
    (bmkp-file-this-dir-some-tags-jump-other-window
     icicle-bookmark-file-this-dir-some-tags-other-window <span class="linecomment">; `C-x 4 j t C-f +'</span>
     (fboundp 'bmkp-file-this-dir-some-tags-jump))
    (bmkp-file-this-dir-some-tags-regexp-jump
     icicle-bookmark-file-this-dir-some-tags-regexp   <span class="linecomment">; `C-x j t % C-f +'</span>
     (fboundp 'bmkp-file-this-dir-some-tags-regexp-jump))
    (bmkp-file-this-dir-some-tags-regexp-jump-other-window
     icicle-bookmark-file-this-dir-some-tags-regexp-other-window <span class="linecomment">; `C-x 4 j t % C-f +'</span>
     (fboundp 'bmkp-file-this-dir-some-tags-regexp-jump))
    (bmkp-url-jump
     icicle-bookmark-url (fboundp 'bmkp-url-jump))                             <span class="linecomment">; `C-x j u'</span>
    (bmkp-url-jump-other-window
     icicle-bookmark-url-other-window (fboundp 'bmkp-url-jump))                <span class="linecomment">; `C-x 4 j u'</span>
    (bmkp-w3m-jump
     icicle-bookmark-w3m (fboundp 'bmkp-w3m-jump))                             <span class="linecomment">; `C-x j w'</span>
    (bmkp-w3m-jump-other-window
     icicle-bookmark-w3m-other-window (fboundp 'bmkp-w3m-jump))                <span class="linecomment">; `C-x 4 j w'</span>
    ...
    (,(kbd "<span class="quote">ESC M-x</span>")      lacarte-execute-command <span class="linecomment">; `ESC M-x'</span>
     (fboundp 'lacarte-execute-command))
    (,(kbd "<span class="quote">M-`</span>")          lacarte-execute-menu-command <span class="linecomment">; `M-`' - replaces `tmm-menubar'.</span>
     (fboundp 'lacarte-execute-menu-command))
    (,(kbd "<span class="quote">&lt;f10&gt;</span>")        lacarte-execute-menu-command <span class="linecomment">; `f10' - replaces `menu-bar-open'.</span>
     (fboundp 'lacarte-execute-menu-command)))
...
(defcustom icicle-top-level-when-sole-completion-delay 0.7
  "<span class="quote">*Number of secs to wait to return to top level if only one completion.
...
(defcustom icicle-type-actions-alist
  '(("<span class="quote">buffer</span>"
     (lambda (b) (with-current-buffer b (ps-print-buffer))) <span class="linecomment">; E.g. showing you can use lambda.</span>
    ...
    ("<span class="quote">option</span>" custom-note-var-changed  customize-option  customize-option-other-window
  ...
  "<span class="quote">*Alist of Emacs object types and associated actions.
...
There is no doubt that the default value could be improved.]</span>"
  :type '(alist
          :key-type   (string :tag "<span class="quote">Object type</span>")
          <span class="linecomment">;; We cannot use type `function' because some symbols might not yet be `fboundp'.</span>
          :value-type (repeat (restricted-sexp :tag "<span class="quote">Action (function)</span>"
...
also remove properties such as `face'.</span>"
  :type 'boolean :group 'Icicles-Miscellaneous)
...
(defcustom icicle-use-anything-candidates-flag t
  "<span class="quote">*Non-nil means Icicles can include Anything candidates for completion.
...
See also non-option variable `icicle-use-candidates-only-once-alt-p'.</span>"
  :type 'boolean :group 'Icicles-Matching)

<span class="linecomment">;;;###autoload</span>
(defcustom icicle-word-completion-keys '([(meta ?\ )]) <span class="linecomment">; `M-SPC'</span>
...
that (non-Icicles) function does not support WYSIWYG candidates.</span>"
  :type '(choice
