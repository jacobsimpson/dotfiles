...
<html xmlns="http://www.w3.org/1999/xhtml"><head><title>EmacsWiki: icicles-cmd2.el</title><link rel="alternate" type="application/wiki" title="Edit this page" href="http://www.emacswiki.org/emacs?action=edit;id=icicles-cmd2.el" /><link type="text/css" rel="stylesheet" href="/emacs/wiki.css" /><meta name="robots" content="INDEX,FOLLOW" /><link rel="alternate" type="application/rss+xml" title="EmacsWiki" href="http://www.emacswiki.org/emacs?action=rss" /><link rel="alternate" type="application/rss+xml" title="EmacsWiki: icicles-cmd2.el" href="http://www.emacswiki.org/emacs?action=rss;rcidonly=icicles-cmd2.el" />
...
<link rel="alternate" type="application/rss+xml"
      title="Changes for icicles-cmd2.el only"
      href="http://www.emacswiki.org/emacs?action=rss;rcidonly=icicles-cmd2.el" />
...
<h1><a title="Click to search for references to this page" rel="nofollow" href="http://www.google.com/cse?cx=004774160799092323420:6-ff2s0o6yi&amp;q=%22icicles-cmd2.el%22">icicles-cmd2.el</a></h1></div><div class="wrapper"><div class="content browse"><p class="download"><a href="http://www.emacswiki.org/emacs/download/icicles-cmd2.el">Download</a></p><pre class="code"><span class="linecomment">;;; icicles-cmd2.el --- Top-level commands for Icicles</span>
<span class="linecomment">;;</span>
<span class="linecomment">;; Filename: icicles-cmd2.el</span>
...
<span class="linecomment">;; Created: Thu May 21 13:31:43 2009 (-0700)</span>
<span class="linecomment">;; Version: 22.0</span>
<span class="linecomment">;; Last-Updated: Fri Jun  3 15:50:53 2011 (-0700)</span>
<span class="linecomment">;;           By: dradams</span>
<span class="linecomment">;;     Update #: 3328</span>
<span class="linecomment">;; URL: http://www.emacswiki.org/cgi-bin/wiki/icicles-cmd2.el</span>
...
<span class="linecomment">;;   `fuzzy', `fuzzy-match', `hexrgb', `icicles-cmd1',</span>
<span class="linecomment">;;   `icicles-face', `icicles-fn', `icicles-mcmd', `icicles-opt',</span>
<span class="linecomment">;;   `icicles-var', `image-dired', `kmacro', `levenshtein',</span>
<span class="linecomment">;;   `misc-fns', `mouse3', `mwheel', `pp', `pp+', `regexp-opt',</span>
<span class="linecomment">;;   `ring', `ring+', `strings', `thingatpt', `thingatpt+',</span>
...
<span class="linecomment">;;  those commands).  This is a continuation of library</span>
<span class="linecomment">;;  `icicles-cmd1.el' (a single file for all top-level commands would</span>
<span class="linecomment">;;  be too large to upload to Emacs Wiki).</span>
<span class="linecomment">;;</span>
...
<span class="linecomment">;;  `icicles-cmd2.elc', in Emacs 23, then it must be byte-compiled</span>
...
<span class="linecomment">;;    `icicle-with-comments-hidden'.</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;  Commands defined here - (+) means a multi-command:</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;    (+)`a', (+)`any', (+)`buffer', (+)`file', (+)`icicle-anything',</span>
...
<span class="linecomment">;;    (+)`icicle-comint-command', (+)`icicle-comint-search',</span>
...
<span class="linecomment">;;    (+)`icicle-describe-option-of-type', (+)`icicle-doc',</span>
<span class="linecomment">;;    (+)`icicle-exchange-point-and-mark', (+)`icicle-font',</span>
...
<span class="linecomment">;;    `icicle-hide/show-comments', (+)`icicle-imenu',</span>
<span class="linecomment">;;    (+)`icicle-imenu-command',</span>
<span class="linecomment">;;    (+)`icicle-imenu-non-interactive-function',</span>
<span class="linecomment">;;    `icicle-ido-like-mode', (+)`icicle-Info-goto-node',</span>
<span class="linecomment">;;    (+)`icicle-Info-goto-node-cmd', (+)`icicle-Info-index',</span>
<span class="linecomment">;;    (+)`icicle-Info-index-20', (+)`icicle-Info-index-cmd',</span>
<span class="linecomment">;;    (+)`icicle-Info-menu', `icicle-Info-menu-cmd',</span>
<span class="linecomment">;;    `icicle-Info-virtual-book', `icicle-insert-char',</span>
<span class="linecomment">;;    (+)`icicle-insert-thesaurus-entry', (+)`icicle-keyword-list',</span>
<span class="linecomment">;;    (+)`icicle-map', `icicle-next-visible-thing',</span>
<span class="linecomment">;;    `icicle-non-whitespace-string-p', (+)`icicle-object-action',</span>
<span class="linecomment">;;    (+)`icicle-occur', (+)`icicle-plist',</span>
<span class="linecomment">;;    `icicle-previous-visible-thing', `icicle-read-color',</span>
<span class="linecomment">;;    `icicle-read-kbd-macro', (+)`icicle-regexp-list',</span>
...
<span class="linecomment">;;    (+)`icicle-search-buffer', (+)`icicle-search-buff-menu-marked',</span>
<span class="linecomment">;;    (+)`icicle-search-char-property', (+)`icicle-search-defs',</span>
...
<span class="linecomment">;;    (+)`icicle-search-ibuffer-marked',</span>
<span class="linecomment">;;    (+)`icicle-search-info-bookmark', (+)`icicle-search-keywords',</span>
<span class="linecomment">;;    (+)`icicle-search-lines',</span>
...
<span class="linecomment">;;    (+)`icicle-search-paragraphs', (+)`icicle-search-pages',</span>
<span class="linecomment">;;    (+)`icicle-search-region-bookmark',</span>
<span class="linecomment">;;    (+)`icicle-search-remote-file-bookmark',</span>
<span class="linecomment">;;    (+)`icicle-search-sentences',</span>
...
<span class="linecomment">;;    (+)`icicle-search-w3m-bookmark', (+)`icicle-search-word',</span>
<span class="linecomment">;;    (+)`icicle-search-xml-element', (+)`icicle-select-frame',</span>
<span class="linecomment">;;    `icicle-select-frame-by-name',</span>
<span class="linecomment">;;    `icicle-set-S-TAB-methods-for-command',</span>
<span class="linecomment">;;    `icicle-set-TAB-methods-for-command', (+)`icicle-tags-search',</span>
<span class="linecomment">;;    (+)`icicle-vardoc', (+)`icicle-where-is', (+)`what-which-how'.</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;  Non-interactive functions defined here:</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;    `icicle-add-key+cmd', `icicle-anything-candidate-value',</span>
...
<span class="linecomment">;;    `icicle-choose-candidate-of-type', `icicle-comint-hook-fn',</span>
...
<span class="linecomment">;;    `icicle-comint-search-send-input', `icicle-compilation-hook-fn',</span>
...
<span class="linecomment">;;    `icicle-edmacro-parse-keys', `icicle-flat-list',</span>
<span class="linecomment">;;    `icicle-fn-doc-minus-sig', `icicle-font-w-orig-size',</span>
...
<span class="linecomment">;;    `icicle-insert-thesaurus-entry-cand-fn', `icicle-invisible-p',</span>
<span class="linecomment">;;    `icicle-keys+cmds-w-prefix', `icicle-marker+text',</span>
<span class="linecomment">;;    `icicle-markers', `icicle-next-single-char-property-change',</span>
...
<span class="linecomment">;;    `icicle-region-or-buffer-limits', `icicle-search-action',</span>
...
<span class="linecomment">;;    `icicle-search-replace-search-hit', `icicle-search-thing-args',</span>
...
<span class="linecomment">;;    `icicle-things-alist', `icicle-this-command-keys-prefix'.</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;  Internal variables defined here:</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;    `icicle-active-map', `icicle-info-buff', `icicle-info-window',</span>
<span class="linecomment">;;    `icicle-key-prefix', `icicle-key-prefix-2',</span>
<span class="linecomment">;;    `icicle-last-thing-type', `icicle-named-colors',</span>
<span class="linecomment">;;    `icicle-orig-buff-key-complete', `icicle-orig-extra-cands',</span>
<span class="linecomment">;;    `icicle-orig-font', `icicle-orig-frame', `icicle-orig-menu-bar',</span>
...
<span class="linecomment">;;    `icicle-orig-sort-orders-alist', `icicle-orig-win-key-complete',</span>
<span class="linecomment">;;    `icicle-this-cmd-keys'.</span>
<span class="linecomment">;;</span>
<span class="linecomment">;;</span>
...
<span class="linecomment">;;</span>
<span class="linecomment">;;  (@&gt; "Icicles Top-Level Commands, Part 2")</span>
...
(eval-when-compile (require 'cl)) <span class="linecomment">;; case, loop</span>
...
(eval-when-compile (require 'comint))
  <span class="linecomment">;; comint-check-proc, comint-copy-old-input, comint-get-old-input, comint-input-ring,</span>
  <span class="linecomment">;; comint-prompt-regexp, comint-send-input</span>
...
(eval-when-compile (require 'etags)) <span class="linecomment">;; tags-case-fold-search, tags-table-files,</span>
                                     <span class="linecomment">;; visit-tags-table-buffer</span>
...
(require 'hexrgb nil t)  <span class="linecomment">;; (no error if not found): hexrgb-color-name-to-hex, hexrgb-read-color</span>
...
(require 'icicles-opt)                  <span class="linecomment">; (This is required anyway by `icicles-var.el'.)</span>
  <span class="linecomment">;; icicle-alternative-sort-comparer, icicle-buffer-extras, icicle-buffer-ignore-space-prefix-flag,</span>
  <span class="linecomment">;; icicle-buffer-match-regexp, icicle-buffer-no-match-regexp, icicle-buffer-predicate,</span>
  <span class="linecomment">;; icicle-buffer-require-match-flag, icicle-buffer-sort, icicle-complete-keys-self-insert-flag,</span>
  <span class="linecomment">;; icicle-ignore-space-prefix-flag, icicle-key-descriptions-use-&lt;&gt;-flag, icicle-recenter,</span>
  <span class="linecomment">;; icicle-require-match-flag, icicle-saved-completion-sets,</span>
  <span class="linecomment">;; icicle-search-cleanup-flag, icicle-search-highlight-all-current-flag,</span>
  <span class="linecomment">;; icicle-search-highlight-threshold, icicle-search-hook, icicle-sort-comparer,</span>
...
(require 'icicles-var)                  <span class="linecomment">; (This is required anyway by `icicles-fn.el'.)</span>
  <span class="linecomment">;; icicle-candidate-action-fn, icicle-candidate-entry-fn, icicle-candidate-nb,</span>
  <span class="linecomment">;; icicle-candidates-alist, icicle-char-property-value-history, icicle-complete-keys-alist,</span>
  <span class="linecomment">;; icicle-completion-candidates, icicle-current-input, icicle-extra-candidates,</span>
  <span class="linecomment">;; icicle-get-alist-candidate-function, icicle-must-match-regexp, icicle-must-not-match-regexp,</span>
  <span class="linecomment">;; icicle-must-pass-predicate, icicle-saved-completion-candidates, icicle-search-command,</span>
  <span class="linecomment">;; icicle-search-current-overlay, icicle-search-final-choice, icicle-search-overlays,</span>
...
(require 'icicles-fn)                   <span class="linecomment">; (This is required anyway by `icicles-mcmd.el'.)</span>
  <span class="linecomment">;; icicle-candidate-short-help, icicle-completing-read-history,</span>
  <span class="linecomment">;; icicle-highlight-lighter, icicle-insert-cand-in-minibuffer, icicle-kill-a-buffer</span>
(require 'icicles-cmd1)
  <span class="linecomment">;; custom-variable-p, icicle-bookmark-cleanup,</span>
  <span class="linecomment">;; icicle-bookmark-cleanup-on-quit, icicle-bookmark-cmd, icicle-bookmark-help-string,</span>
  <span class="linecomment">;; icicle-bookmark-history, icicle-bookmark-propertize-candidate, icicle-buffer-list,</span>
  <span class="linecomment">;; icicle-explore, icicle-face-list, icicle-file-list, icicle-make-frame-alist,</span>
...
<span class="linecomment">;; (&lt; emacs-major-version 21)</span>
(defvar tooltip-mode)                   <span class="linecomment">; In `tooltip.el'</span>

<span class="linecomment">;; (&lt; emacs-major-version 22)</span>
...
(defvar synonyms-obarray)               <span class="linecomment">; In `synonyms.el'</span>
...
<span class="linecomment">;; (&gt; emacs-major-version 21)</span>
(defvar Info-saved-nodes)               <span class="linecomment">; In `info+.el'</span>

<span class="linecomment">;; (&lt; emacs-major-version 23)</span>
...
(defvar icicle-orig-font nil
  "<span class="quote">Font of selected frame, before command.</span>")

(defvar icicle-orig-frame nil
  "<span class="quote">Selected frame, before command.</span>")

(defvar icicle-orig-menu-bar nil
  "<span class="quote">`menu-bar-lines' of selected frame, before command.</span>")

(defvar icicle-orig-pixelsize nil
  "<span class="quote">Size of font of selected frame in pixels, before command.</span>")

(defvar icicle-orig-pointsize nil
  "<span class="quote">Size of font of selected frame in points, before command.</span>")

<span class="linecomment">;;;###autoload (autoload 'icicle-font "icicles-cmd2.el")</span>
(icicle-define-command icicle-font      <span class="linecomment">; Command name</span>
  ...
  (lambda (font) (modify-frame-parameters icicle-orig-frame (list (cons 'font font)))) <span class="linecomment">; Action fn</span>
  "<span class="quote">Font: </span>"                              <span class="linecomment">; `completing-read' args</span>
  (let ((fonts  ())
        fws)
    (dolist (ft  (x-list-fonts "<span class="quote">*</span>")  fonts) <span class="linecomment">; Just avoiding two traversals, one to remove nil elts.</span>
      (when (setq fws  (icicle-font-w-orig-size ft)) (push fws fonts)))) <span class="linecomment">; Ignore nil entries.</span>
  nil t nil (if (boundp 'font-name-history) 'font-name-history 'icicle-font-name-history) nil nil
  ((icicle-orig-frame      (selected-frame)) <span class="linecomment">; Bindings</span>
  ...
  <span class="linecomment">;; First code - remove menu-bar, to avoid Emacs bug that resizes frame.</span>
  (modify-frame-parameters icicle-orig-frame (list '(menu-bar-lines . 0)))
  (modify-frame-parameters icicle-orig-frame <span class="linecomment">; Undo code.</span>
                           (list (cons 'font icicle-orig-font) icicle-orig-menu-bar))
  (modify-frame-parameters icicle-orig-frame (list icicle-orig-menu-bar))) <span class="linecomment">; Last code.</span>

<span class="linecomment">;; Free var here: `icicle-orig-pixelsize' is bound in `icicle-font'.</span>
(defun icicle-font-w-orig-size (font)
  "<span class="quote">Return a font like FONT, but with pixel size `icicle-orig-pixelsize'.
Return nil if `x-decompose-font-name' returns nil for FONT.
`icicle-orig-pixelsize' is the original pixel size for `icicle-font'.</span>"
  (let ((xlfd-fields  (x-decompose-font-name font)))
    (if (not xlfd-fields)               <span class="linecomment">; Can't handle such font names - return nil.</span>
        nil
      ...
      (let* ((sized-font   (x-compose-font-name xlfd-fields))
             (font-info    (and (or (&gt; icicle-help-in-mode-line-delay 0) <span class="linecomment">; Only if user will see it.</span>
                                    (and (boundp 'tooltip-mode) tooltip-mode))
                                (font-info sized-font)))
             (iii          (if (&lt; emacs-major-version 21) 3 2))
             (help-string  (if font-info
                               (format "<span class="quote">width: %s, height: %s, offset: %s, compose: %s</span>"
                                       (aref font-info iii) (aref font-info (+ iii 1))
                                       (aref font-info (+ iii 2)) (aref font-info (+ iii 3)))
                             "<span class="quote">Font is not yet loaded (used)</span>")))
        (icicle-candidate-short-help help-string sized-font)
        (list sized-font)))))

(defvar icicle-named-colors ()
  "<span class="quote">Named colors.</span>")

<span class="linecomment">;;;###autoload (autoload 'icicle-frame-bg "icicles-cmd2.el")</span>
(icicle-define-command icicle-frame-bg  <span class="linecomment">; Command name</span>
  "<span class="quote">Change background of current frame.
...
This command is intended only for use in Icicle mode.</span>" <span class="linecomment">; Doc string</span>
  (lambda (color)                       <span class="linecomment">; Action function</span>
    (modify-frame-parameters
     icicle-orig-frame (list (cons 'background-color (icicle-transform-multi-completion color)))))
  icicle-prompt icicle-named-colors nil t nil  <span class="linecomment">; `completing-read' args</span>
  (if (boundp 'color-history) 'color-history 'icicle-color-history) nil nil
  ((icicle-orig-frame                  (selected-frame)) <span class="linecomment">; Bindings</span>
   (orig-bg                            (frame-parameter nil 'background-color))
   (icicle-prompt                      "<span class="quote">Background color: </span>")
   (icicle-list-use-nth-parts          '(2)) <span class="linecomment">; Use RGB part.</span>
   (icicle-candidate-alt-action-fn
    (or icicle-candidate-alt-action-fn (icicle-alt-act-fn-for-type "<span class="quote">color</span>")))
   (icicle-all-candidates-list-alt-action-fn
    (or icicle-all-candidates-list-alt-action-fn (icicle-alt-act-fn-for-type "<span class="quote">color</span>")))
  ...
  (icicle-color-completion-setup)       <span class="linecomment">; First code</span>
  (modify-frame-parameters icicle-orig-frame (list (cons 'background-color orig-bg))) <span class="linecomment">; Undo code</span>
  nil)                                  <span class="linecomment">; Last code</span>

<span class="linecomment">;;;###autoload (autoload 'icicle-frame-fg "icicles-cmd2.el")</span>
(icicle-define-command icicle-frame-fg  <span class="linecomment">; Command name</span>
  "<span class="quote">Change foreground of current frame.
See `icicle-frame-bg' - but this is for foreground, not background.</span>" <span class="linecomment">; Doc string</span>
  (lambda (color)                       <span class="linecomment">; Action function</span>
    (modify-frame-parameters
  ...
  ((icicle-orig-frame                  (selected-frame)) <span class="linecomment">; Bindings</span>
   ...
   (icicle-prompt                      "<span class="quote">Foreground color: </span>")
   (icicle-list-use-nth-parts          '(2)) <span class="linecomment">; Use RGB part.</span>
   (icicle-candidate-alt-action-fn
    (or icicle-candidate-alt-action-fn (icicle-alt-act-fn-for-type "<span class="quote">color</span>")))
   (icicle-all-candidates-list-alt-action-fn
  ...
  (icicle-color-completion-setup)       <span class="linecomment">; First code</span>
  (modify-frame-parameters icicle-orig-frame (list (cons 'foreground-color orig-bg))) <span class="linecomment">; Undo code</span>
  nil)                                  <span class="linecomment">; Last code</span>
...
(defvar icicle-info-buff nil
  "<span class="quote">Info buffer before command was invoked.</span>")

(defvar icicle-info-window nil
  "<span class="quote">Info window before command was invoked.</span>")
...
(defun icicle-Info-index ()
  ...
  (let ((icicle-info-buff            (current-buffer))
        ...
        (C-x-m                       (lookup-key minibuffer-local-completion-map "<span class="quote">\C-xm</span>")))
    (when (and (require 'bookmark+ nil t) (fboundp 'icicle-bookmark-info-other-window))
      (define-key minibuffer-local-completion-map "<span class="quote">\C-xm</span>" 'icicle-bookmark-info-other-window))
    (unwind-protect
         (call-interactively (if (&gt; emacs-major-version 21) 'Info-index 'icicle-Info-index-20))
      (define-key minibuffer-local-completion-map "<span class="quote">\C-xm</span>" C-x-m))))
...
<span class="linecomment">;; Free vars here: `icicle-info-buff' and `icicle-info-window' are bound in `icicle-Info-index'.</span>
...
(icicle-define-command icicle-Info-menu
  ...
  (lambda (m) (icicle-Info-goto-node (cdr (funcall icicle-get-alist-candidate-function m)))) <span class="linecomment">; Action</span>
  ...
  nil
  ((opoint                                 (point)) <span class="linecomment">; Bindings</span>
...
This is an Icicles command - see command `icicle-mode'.</span>"
  (interactive
   (let* ((icicle-info-buff                 (current-buffer))
          ...
          (icicle-sort-orders-alist         (cons '("<span class="quote">in book order</span>" .  icicle-Info-book-order-p)
                                                  icicle-sort-orders-alist))
          (icicle-sort-comparer             (if icicle-Info-only-rest-of-book-p
                                                #'icicle-Info-book-order-p
                                              icicle-sort-comparer)))
     (list (icicle-Info-read-node-name "<span class="quote">Go to node: </span>" (consp current-prefix-arg))
           current-prefix-arg)))
...
(defun icicle-Info-read-node-name (prompt &optional include-file-p)
  "<span class="quote">Read a node name, prompting with PROMPT.
...
You can use `C-x m' during completion to access Info bookmarks, if you
 use library `bookmark+.el'.</span>"
  (let ((C-x-m  (lookup-key minibuffer-local-completion-map "<span class="quote">\C-xm</span>")))
    (when (and (require 'bookmark+ nil t) (fboundp 'icicle-bookmark-info-other-window))
      (define-key minibuffer-local-completion-map "<span class="quote">\C-xm</span>" 'icicle-bookmark-info-other-window))
    (unwind-protect
...
Non-nil INCLUDE-FILE-P means include current Info file in the name.</span>"
  ...
  (if (or (not icicle-Info-only-rest-of-book-p) (string= Info-current-node "<span class="quote">Top</span>"))
    ...
    (reverse (cons '("<span class="quote">..</span>")
...
(defun icicle-Info-build-node-completions-1 (&optional include-file-p)
  "<span class="quote">Helper function for `icicle-Info-build-node-completions'.
Use `Info-build-node-completions' to build node list for completion.
Non-nil INCLUDE-FILE-P means include current Info file in the name.
Remove pseudo-node `*'.  (This just fixes a bug in Emacs 21 and 22.1.)</span>"
  (let ((comps  (Info-build-node-completions)))
    (when (equal (car comps) '("<span class="quote">*</span>")) (setq comps  (cdr comps)))
    (if include-file-p
        (let ((file  (concat "<span class="quote">(</span>" (cond ((stringp Info-current-file)
                                        (replace-regexp-in-string
                                         "<span class="quote">%</span>" "<span class="quote">%%</span>" (file-name-nondirectory Info-current-file)))
                                       (Info-current-file (format "<span class="quote">*%S*</span>" Info-current-file))
...
<span class="linecomment">;; `icicle-info-buff' and `icicle-info-window' are bound in `icicle-Info-goto-node'.</span>
...
(when (&gt; emacs-major-version 21)
  (defun icicle-Info-virtual-book (nodeset)
    "<span class="quote">Open Info on a virtual book of saved Info nodes.
...
With no prefix arg, use `icicle-saved-completion-candidates', which
 ...
 `Info-saved-nodes'.
Non-interactively, argument NODESET is a list of Info node names.</span>"
    (interactive
     (progn (unless (and (require 'info+ nil t) (fboundp 'Info-virtual-book))
              (error "<span class="quote">You need library `info+.el' for this command</span>"))
            (list (if (not current-prefix-arg)
                      "<span class="quote">Virtual Book</span>"
                    (save-selected-window
                      (completing-read "<span class="quote">Saved Info node set: </span>" icicle-saved-completion-sets nil t nil
                                       'icicle-completion-set-history))))))
    (let ((nodes  (and (consp nodeset) nodeset))) <span class="linecomment">; (), if interactive - NODESET is a string then.</span>
      (when (interactive-p)
        (if (not current-prefix-arg)
          ...
          (let ((file-name  (cdr (assoc nodeset icicle-saved-completion-sets))))
            (unless (icicle-file-readable-p file-name)
              (error "<span class="quote">Cannot read cache file `%s'</span>" file-name))
              ...
              (unwind-protect
                   (condition-case icicle-Info-virtual-book
                       (when (listp (setq nodes  (read list-buf)))
                         (message "<span class="quote">Set `%s' read from file `%s'</span>" nodeset file-name))
                     (error (error "<span class="quote">Bad cache file.  %s</span>"
                                   (error-message-string icicle-Info-virtual-book))))
                (kill-buffer list-buf))
              (unless (consp nodes) (error "<span class="quote">Bad data in cache file `%s'</span>" file-name))))))
      (unless nodes (setq nodes  Info-saved-nodes)) <span class="linecomment">; In `info+.el'.</span>
      (unless (and nodes (stringp (car nodes))) (error "<span class="quote">No saved Info nodes</span>")) <span class="linecomment">; Minimal check.</span>
      (unless (stringp nodeset) (setq nodeset "<span class="quote">Virtual Book</span>")) <span class="linecomment">; Non-interactive - NODESET is a list.</span>
      (Info-virtual-book nodeset nodes))))

<span class="linecomment">;;;###autoload (autoload 'icicle-insert-thesaurus-entry "icicles-cmd2.el")</span>
...
\\[icicle-toggle-incremental-completion] to toggle incremental completion.</span>" <span class="linecomment">; Doc string</span>
  icicle-insert-thesaurus-entry-cand-fn <span class="linecomment">; Action function</span>
  ...
  (when (window-live-p icicle-orig-window) <span class="linecomment">; Undo code</span>
    (select-window icicle-orig-window)
    (select-frame-set-input-focus (selected-frame))
    (goto-char icicle-track-pt))
  (when (window-live-p icicle-orig-window) <span class="linecomment">; Last code</span>
    (select-window icicle-orig-window)
    (select-frame-set-input-focus (selected-frame))
    (goto-char icicle-track-pt)))

<span class="linecomment">;; Free vars here: `icicle-orig-buff' is bound in `icicle-insert-thesaurus-entry'.</span>
...
<span class="linecomment">;;;###autoload (autoload 'icicle-where-is "icicles-cmd2.el")</span>
...
remapping, then customize option `icicle-top-level-key-bindings'.</span>" <span class="linecomment">; Doc string</span>
  ...
  (if pref-arg "<span class="quote">Where is command: </span>" "<span class="quote">Where is bound command: </span>")
  obarray nil t nil nil <span class="linecomment">; `completing-read' args</span>
  (let ((fn  (or (and (fboundp 'symbol-nearest-point) (symbol-nearest-point))
                 (function-called-at-point))))
    (and fn (symbol-name fn)))
  t
  ((pref-arg  current-prefix-arg)       <span class="linecomment">; Bindings</span>
    ...
    #'(lambda (c)
        (with-current-buffer icicle-orig-buff
          (let* ((keys   (where-is-internal (intern-soft c) overriding-local-map))
            ...
            (message (if (string= "<span class="quote"></span>" keys1)
                         (format "<span class="quote">`%s' is not on any key</span>" c)
                       (format "<span class="quote">`%s' is on `%s'</span>" c keys1)))
            (sit-for 3)))))
   (icicle-candidate-alt-action-fn
    (or icicle-candidate-alt-action-fn (icicle-alt-act-fn-for-type "<span class="quote">command</span>")))
   (icicle-all-candidates-list-alt-action-fn
    (or icicle-all-candidates-list-alt-action-fn (icicle-alt-act-fn-for-type "<span class="quote">command</span>")))))

<span class="linecomment">;;;###autoload (autoload 'icicle-describe-option-of-type "icicles-cmd2.el")</span>
          ...
          (mapcar #'(lambda (entry)
                      (let* ((opt+typ-string  (concat (mapconcat #'(lambda (e) (pp-to-string e))
                             ...
                             (doc1  (and (stringp doc)
                                         (string-match "<span class="quote">.+$</span>" doc) (match-string 0 doc))))
...
<span class="linecomment">;;;###autoload (autoload 'icicle-vardoc "icicles-cmd2.el")</span>
...
\\[icicle-toggle-incremental-completion] to toggle incremental completion.</span>" <span class="linecomment">; Doc string</span>
  ...
  ((prompt                             "<span class="quote">VAR `C-M-j' DOC: </span>") <span class="linecomment">; Bindings</span>
   (icicle-candidate-properties-alist  '((1 (face icicle-candidate-part))))
...
<span class="linecomment">;;; $$$$$$ (defun icicle-funvardoc-action (entry)</span>
<span class="linecomment">;;;   "Action function for `icicle-vardoc', `icicle-fundoc', `icicle-plist'."</span>
<span class="linecomment">;;;   (with-output-to-temp-buffer "*Help*" (princ entry)))</span>

<span class="linecomment">;;;###autoload (autoload 'icicle-fundoc "icicles-cmd2.el")</span>
...
\\[icicle-toggle-incremental-completion] to toggle incremental completion.</span>" <span class="linecomment">; Doc string</span>
  ...
  (let ((result  (and pref-arg icicle-fundoc-last-initial-cand-set)))
    ...
    result)
  nil nil nil 'icicle-doc-history nil nil
  ((prompt                             "<span class="quote">FUNC `C-M-j' DOC: </span>") <span class="linecomment">; Bindings</span>
   (icicle-candidate-properties-alist  '((1 (face icicle-candidate-part))))
   (icicle-list-use-nth-parts          '(1))
   (pref-arg                           current-prefix-arg))
  (progn
...
<span class="linecomment">;;;###autoload (autoload 'icicle-plist "icicles-cmd2.el")</span>
...
\\[icicle-toggle-incremental-completion] to toggle incremental completion.</span>" <span class="linecomment">; Doc string</span>
                 ...
                 (when plist
                   (push (list (list (symbol-name symb)
                                     (if (or (&lt; (prefix-numeric-value pref-arg) 0)
                                             (&lt; emacs-major-version 21)) <span class="linecomment">; Emacs 20 crash if pprint.</span>
                                         (format "<span class="quote">%s</span>" plist)
                                       (pp-to-string plist))))
                         result)))
             (error nil))))
  ...
  ((prompt                             "<span class="quote">SYMB `C-M-j' PLIST: </span>") <span class="linecomment">; Bindings</span>
   (icicle-candidate-properties-alist  '((1 (face icicle-candidate-part))))
   (icicle-list-use-nth-parts          '(1))
   (pref-arg                           current-prefix-arg))
  (progn
...
<span class="linecomment">;;;###autoload (autoload 'icicle-doc "icicles-cmd2.el")</span>
...
`\\[icicle-toggle-incremental-completion]' to toggle incremental completion.</span>" <span class="linecomment">; Doc string</span>
  ...
  (let ((result  (and pref-arg icicle-doc-last-initial-cand-set))
    ...
    result)
  nil nil nil 'icicle-doc-history nil nil
  ((prompt                             "<span class="quote">Find doc using regexp: </span>") <span class="linecomment">; Bindings</span>
   (icicle-candidate-properties-alist  '((1 (face icicle-candidate-part))))
   (icicle-list-use-nth-parts          '(1))
      ...
      (let ((icicle-must-pass-after-match-predicate  #'(lambda (s) (user-variable-p (intern s)))))
        (list (completing-read
               (concat "<span class="quote">Apropos user option (regexp</span>" (and (&gt;= emacs-major-version 22) "<span class="quote"> or words</span>")
                       "<span class="quote">): </span>") obarray nil nil nil 'regexp-history))))
...
to nil so that candidates with initial spaces can be matched.</span>"
                  ...
                  `(lambda (s)
                      ...
                      (and (boundp s) (consp (symbol-value s))
                           ,(if current-prefix-arg
                                ...
                                '(string-match "<span class="quote">alist$</span>" (symbol-name s))))))
                 (icicle-candidate-alt-action-fn
                  (or icicle-candidate-alt-action-fn
                      (icicle-alt-act-fn-for-type "<span class="quote">variable</span>")))
                 (icicle-all-candidates-list-alt-action-fn
                  (or icicle-all-candidates-list-alt-action-fn
                      (icicle-alt-act-fn-for-type "<span class="quote">variable</span>"))))
             (completing-read "<span class="quote">Alist (variable): </span>" obarray nil t nil
         ...
         (read
          (let ((icicle-must-pass-after-match-predicate  #'(lambda (s) (functionp (intern s))))
                ...
                (icicle-all-candidates-list-alt-action-fn
                 (or icicle-all-candidates-list-alt-action-fn
                     (icicle-alt-act-fn-for-type "<span class="quote">function</span>"))))
            (completing-read "<span class="quote">Function: </span>" obarray nil nil nil (if (boundp 'function-name-history)
  ...
  (let ((icicle-candidate-action-fn            'icicle-apply-action)
    ...
    (icicle-explore
     ...
     nil nil nil "<span class="quote">Choose an occurrence: </span>" predicate t initial-input hist def inherit-input-method)))
...
remapping, then customize option `icicle-top-level-key-bindings'.</span>"
  ...
  (if (not (wholenump (prefix-numeric-value arg)))
      (icicle-goto-marker)
    (setq this-command 'set-mark-command) <span class="linecomment">; Let `C-SPC C-SPC' activate if not `transient-mark-mode'.</span>
...
command `icicle-mode'.</span>"
  (interactive)
  (let ((icicle-sort-orders-alist  (cons '("<span class="quote">by position</span>" .  icicle-cdr-lessp)
                                         icicle-sort-orders-alist))
...
prefixed by MARKER's buffer name.</span>"
  (with-current-buffer (marker-buffer marker)
    (save-excursion
      (goto-char marker)
      (let ((line  (let ((inhibit-field-text-motion  t)) <span class="linecomment">; Just to be sure, for `end-of-line'.</span>
            ...
            (help  (and (or (&gt; icicle-help-in-mode-line-delay 0) <span class="linecomment">; Get it only if user will see it.</span>
                            (and (boundp 'tooltip-mode) tooltip-mode))
                        (format "<span class="quote">Line: %d, Char: %d</span>" (line-number-at-pos) (point)))))
...
(defun icicle-exchange-point-and-mark (&optional arg) <span class="linecomment">; Bound to `C-x C-x'.</span>
  "<span class="quote">`exchange-point-and-mark' or save a region or select a saved region.
...
then customize option `icicle-top-level-key-bindings'.</span>"
  ...
  (let ((bplus  (featurep 'bookmark+)))
    (if (not arg)
      ...
      (unless bplus (error "<span class="quote">You must load library `bookmark+.el' to use a prefix arg</span>"))
      (cond ((atom arg)
             (unless (and transient-mark-mode mark-active (not (eq (mark) (point))))
               (error "<span class="quote">Cannot bookmark inactive region: you must activate it first</span>"))
             (icicle-bookmark-cmd (and (natnump (prefix-numeric-value arg)) 9)))
            (t
             (bookmark-maybe-load-default-file)
             (unless (consp (bmkp-region-alist-only)) (error "<span class="quote">No bookmarked regions</span>"))
...
This command is intended for use only in Icicle mode.</span>"
  ...
  (let ((icicle-candidate-action-fn                  (or icicle-candidate-action-fn
        ...
        (icicle-scan-fn-or-regexp           scan-fn-or-regexp) <span class="linecomment">; Used free in `M-,'.</span>
        ...
        <span class="linecomment">;; Alternative: If we used `icicle-search-replace-cand-in-alist', then we would inhibit</span>
        <span class="linecomment">;; sorting, because we would be depending on the alist order.</span>
        <span class="linecomment">;;    (icicle-inhibit-sort-p          t)</span>

        (icicle-no-match-hook               icicle-no-match-hook)
        (completion-ignore-case             case-fold-search)
        (replace-count                      0)) <span class="linecomment">; Defined in `replace.el'.  Used for replacement.</span>
...
The arguments are for use by `completing-read' to read the regexp.
 ...
 A default prompt is used if PROMPT is nil.</span>"
  (setq hist    (or hist 'regexp-history)
        prompt  (or prompt "<span class="quote">Search within contexts (regexp): </span>"))
...
(defun icicle-search-where-arg ()
  ...
  (cond ((consp current-prefix-arg)
         (unless (require 'bookmark+ nil t) (error "<span class="quote">This requires library `bookmark+.el'</span>"))
         (message "<span class="quote">Searching multiple bookmarks...</span>") (sit-for 1)
...
<span class="linecomment">;; Free vars here: `icicle-orig-pt-explore', `icicle-orig-win-explore' are bound in `icicle-explore'.</span>
...
<span class="linecomment">;; Free vars here: `icicle-orig-win-explore' is bound in `icicle-explore'.</span>
(defun icicle-search-cleanup ()
  "<span class="quote">Clean up search highlighting, if `icicle-search-cleanup-flag'.
...
The arguments are the same as for `icicle-search'.</span>"
  ...
  (cond ((and (consp where) (bufferp (car where))) <span class="linecomment">; List of buffers - search buffers.</span>
        ...
        ((and (consp where) (stringp (car where)) <span class="linecomment">; List of files - search files.</span>
              (file-exists-p (car where)))
         (dolist (file  where)
           (icicle-search-define-candidates-1 (find-file-noselect file 'nowarn) nil nil
                                              scan-fn-or-regexp args)))
        ((consp where)                  <span class="linecomment">; Search all bookmarked regions.</span>
         (unless (require 'bookmark+ nil t) (error "<span class="quote">This requires library `bookmark+.el'</span>"))
  ...
  (setq mark-active  nil))              <span class="linecomment">; Remove any region highlighting, so we can see search hits.</span>
...
Highlight the matches in face `icicle-search-main-regexp-others'.</span>"
  ...
  (let ((add-bufname-p  (and buffer icicle-show-multi-completion-flag))
    ...
    (when (bufferp buffer)     <span class="linecomment">; Do nothing if BUFFER is not a buffer.</span>
              ...
              (while (and beg (&lt; beg end) (not (eobp)))
                ...
                (when beg
                  ...
                  (let ((hit-string  (buffer-substring-no-properties
                    ...
                    (when (and (not (string= "<span class="quote"></span>" hit-string)) <span class="linecomment">; Do nothing if empty hit.</span>
                      ...
                      (icicle-candidate-short-help
                       (concat (and add-bufname-p
                                    (format "<span class="quote">Buffer: `%s', </span>"
                                            (buffer-name (marker-buffer end-marker))))
                               (format "<span class="quote">Position: %d, Length: %d</span>"
      ...
      (let ((hits  ())
        ...
        (save-excursion
          ...
          (when (and icicle-expand-input-to-common-match-flag  hits)
            ...
            (when (string= "<span class="quote"></span>" icicle-search-ecm) (setq icicle-search-ecm  nil)))
          (when (or icicle-search-ecm (and input (not (string= "<span class="quote"></span>" input))))
            (dolist (ov  icicle-search-overlays)
              (set-buffer (overlay-buffer ov))
              (unless (equal (overlay-start ov) (overlay-end ov))
                (save-restriction       <span class="linecomment">; Search within the current search context.</span>
...
(defun icicle-search-replace-search-hit (candidate) <span class="linecomment">; Bound to `C-S-RET' (`icicle-search').</span>
  "<span class="quote">Replace search hit CANDIDATE with `icicle-search-replacement'.</span>"
  <span class="linecomment">;; NOTE: We allow side effects during replacement.</span>
  <span class="linecomment">;; In particular, `icicle-completion-candidates', `icicle-candidate-nb', and `icicle-last-input'</span>
  <span class="linecomment">;; can change.</span>
  ...
  (let (<span class="linecomment">;; (icicle-candidate-nb          icicle-candidate-nb)</span>
        ...
        <span class="linecomment">;; (icicle-last-input            icicle-last-input)</span>
    ...
    (unless (or icicle-candidate-nb icicle-all-candidates-action)
      (error "<span class="quote">No current candidate.  Cycle or complete to get to a candidate</span>"))
  ...
  (funcall icicle-candidate-action-fn candidate icicle-search-replacement)) <span class="linecomment">; Call with second arg.</span>

(defun icicle-search-replace-all-search-hits (candidates) <span class="linecomment">; Bound to `M-|' (for `icicle-search').</span>
  "<span class="quote">Default alternative list action function for `icicle-search'.
CANDIDATES is a list of search-hit strings.  They are all matched by
the initial regexp (context regexp).</span>"
  (let ((icicle-last-completion-command  icicle-last-completion-command)
        (compl-win                       (get-buffer-window "<span class="quote">*Completions*</span>" 0)))
<span class="linecomment">;;; $$$$$$ These are now avoided always for all candidates, in `icicle-all-candidates-action-1'.</span>
<span class="linecomment">;;;     (icicle-minibuffer-message-ok-p  nil) ; Avoid delays from `icicle-msg-maybe-in-minibuffer'.</span>
<span class="linecomment">;;;     (icicle-help-in-mode-line-delay  0)) ; Avoid delays for individual candidate help.</span>
    (unless icicle-search-replacement
      (icicle-search-define-replacement)
      (when (and compl-win icicle-completion-candidates)
        (with-output-to-temp-buffer "<span class="quote">*Completions*</span>"
...
(defun icicle-search-action (string &optional replace-string) <span class="linecomment">; Bound to `C-RET' (`icicle-search').</span>
  "<span class="quote">Default completion action function for `icicle-search'.
...
4. Highlight the current candidate in `*Completions*'.
  ...
  (prog1
      (let* ((icicle-whole-candidate-as-text-prop-p  t)
             <span class="linecomment">;; Alternative: If we used `icicle-search-replace-cand-in-alist', then we would bind that</span>
             <span class="linecomment">;; to nil to force using the alist, because we would be performing side effects on it.</span>
...
(defun icicle-search-action-1 (cand+mrker &optional replace-string)
  "<span class="quote">Same as `icicle-search-action', but using full candidate, not string.
CAND+MRKER is a full alist completion-candidate entry, not just a
display string as in `icicle-search-action'.</span>"
            ...
            (condition-case icicle-search-action-1-save-window
                (save-selected-window
                  ...
                  (let ((completion-ignore-case  case-fold-search)
                    ...
                    (icicle-highlight-candidate-in-Completions)
                    (run-hooks 'icicle-search-hook)))
              (error                    <span class="linecomment">; Ignore disappearance of `*Completions*'.</span>
               (unless (string-match "<span class="quote">Wrong type argument: window-live-p,</span>"
...
(defun icicle-search-in-context-default-fn (cand+mrker replace-string)
  ...
  (let ((candidate  (if (consp (car-safe cand+mrker))
                      ...
                      (car-safe cand+mrker)))
        (marker     (cdr-safe cand+mrker)))
    <span class="linecomment">;; Highlight match and possibly replace.  If replacement tried, then update the dialog state.</span>
    (when (save-excursion (save-restriction <span class="linecomment">; Search within the current search context.</span>
                            (narrow-to-region (- marker (length candidate)) marker)
                            (icicle-search-highlight-and-maybe-replace cand+mrker replace-string)))
      <span class="linecomment">;; Update, since replacement might have changed the current candidate:</span>
      <span class="linecomment">;; Rehighlight current context, update last candidate, update candidate in minibuffer.</span>
      (if icicle-search-highlight-all-current-flag
        ...
        (let ((ov  icicle-search-current-overlay))
          (save-restriction (narrow-to-region (overlay-start ov) (overlay-end ov))
                            (icicle-search-highlight-input-matches-here))))
      (if (null icicle-completion-candidates) <span class="linecomment">; If have already replaced all, then no candidates.</span>
...
Return non-nil if replacement occurred, nil otherwise.</span>"
      ...
      (let ((candidate  (if (consp (car-safe cand+mrker))
        ...
        (cond (icicle-search-replace-whole-candidate-flag
               (cond ((string= candidate replace-string) <span class="linecomment">; Sanity check only.</span>
                      (save-restriction (widen) (message "<span class="quote">Replacement = candidate, and \
current input matches candidate</span>") (sit-for 2))
              ...
              ((not (save-excursion (re-search-forward (or ecm icicle-current-input) nil t)))
               (save-restriction (widen)
                                 (message "<span class="quote">Text to be replaced not found in candidate</span>") (sit-for 2))
               (setq replacement-p  nil))
              (t
               (save-match-data
                 (let ((first-p  t))
                   <span class="linecomment">;; The condition order is important.  Don't search unless first time (or all)</span>
        ...
        (when replacement-p
          <span class="linecomment">;; Update the alist and `minibuffer-completion-table' with the new text.</span>

          <span class="linecomment">;; An ALTERNATIVE approach would be to use `icicle-search-replace-cand-in-alist'.</span>
          <span class="linecomment">;; In that case we would:</span>
          <span class="linecomment">;; 1. Bind `icicle-whole-candidate-as-text-prop-p' to nil (in `icicle-search-action'</span>
          <span class="linecomment">;;    and `icicle-search-help').</span>
          <span class="linecomment">;; 2. Use these two lines, instead of calling `icicle-search-replace-cand-in-mct'.</span>
          <span class="linecomment">;;    (icicle-search-replace-cand-in-alist cand+mrker</span>
          <span class="linecomment">;;                                         (buffer-substring (point-min) (point-max)))</span>
          <span class="linecomment">;;    (setq minibuffer-completion-table</span>
          <span class="linecomment">;;          (car (icicle-mctize-all icicle-candidates-alist nil)))</span>
          <span class="linecomment">;;  If we used that method (as we used to), then users could not sort the search hits.</span>

          (icicle-search-replace-cand-in-mct cand+mrker (buffer-substring (point-min) (point-max)))

          <span class="linecomment">;; If we are replacing input matches within a search context, and there are no more matches</span>
          <span class="linecomment">;; in the current context, then this context is removed as a candidate. If the current</span>
          <span class="linecomment">;; action command is one that moves to the next or previous candidate, then we might need</span>
          <span class="linecomment">;; to adjust the current candidate number, to compensate for the removal.</span>
          <span class="linecomment">;;</span>
          <span class="linecomment">;; If the current action command is one (e.g. `C-S-next'), that moves to the next candidate</span>
          <span class="linecomment">;; to do its action, then move back one.  If the current action acts on the previous</span>
          <span class="linecomment">;; candidate (e.g. `C-S-prior'), and that previous candidate is the last one, then move</span>
          <span class="linecomment">;; forward one candidate, to the first.</span>
          (when (and icicle-acting-on-next/prev
                     (not (save-excursion (goto-char (point-min))
                                          (re-search-forward icicle-current-input nil t))))
            (let ((nb-cands  (1- (length icicle-completion-candidates)))) <span class="linecomment">; -1 for replaced one.</span>
          ...
          (let ((icicle-candidate-nb             icicle-candidate-nb)
                (icicle-minibuffer-message-ok-p  nil)) <span class="linecomment">; Inhibit no-candidates message.</span>
            (icicle-complete-again-update))

          <span class="linecomment">;; If we are using `C-S-RET' and we are on the last candidate, then wrap to the first one.</span>
          ...
          (icicle-highlight-candidate-in-Completions)
          (icicle-search-highlight-context-levels))))
    replacement-p))                     <span class="linecomment">; Return indication of whether we tried to replace something.</span>
        ...
        (condition-case icicle-search-replace-match1
            (let ((enable-recursive-minibuffers    t) <span class="linecomment">; So we can read input from \?.</span>
              ...
              (replace-match-maybe-edit
               (if (consp compiled)
                   <span class="linecomment">;; `replace-count' is free here, bound in `icicle-search'.</span>
          ...
          (buffer-read-only (ding) (error "<span class="quote">Buffer is read-only</span>"))
 ...
 * `case-replace' or `case-fold-search' is nil</span>"
  (and from (not (and case-fold-search case-replace (string= from (downcase from))))))

<span class="linecomment">;; Not used for now - this could replace using mct.  In that case, user must not be able to sort.</span>
(defun icicle-search-replace-cand-in-alist (cand+mrker new-cand)
  "<span class="quote">In `icicle-candidates-alist', replace car of CAND+MRKER by NEW-CAND.
Replace only the first occurrence of CAND+MRKER in
`icicle-candidates-alist'.  (There should be only one.)</span>"
...
(defun icicle-search-replace-cand-in-mct (cand+mrker new-cand)
  "<span class="quote">Replace candidate in `minibuffer-completion-table'.
Update CAND+MRKER itself to use NEW-CAND (replacement string).
Any text properties on CAND+MRKER's string are preserved.
Use this only with a `minibuffer-completion-table' derived from an alist.</span>"
  (let ((newlist  minibuffer-completion-table))
    (catch 'icicle-search-replace-cand-in-mct
      <span class="linecomment">;; CAND+MRKER: ("aa" . c) or (("aa" "bb") . c)</span>
      <span class="linecomment">;; `minibuffer-completion-table' entry: ("aa" "aa" . c) or ("aa^G^Jbb" . (("aa" "bb") . c))</span>
      (while newlist
        (when (equal (cdr (car newlist)) cand+mrker)
          (let ((new-compl  (if (consp (car cand+mrker)) <span class="linecomment">; New completion: "QQ" or ("QQ" "bb")</span>
            ...
            <span class="linecomment">;; NEWLIST is done.</span>
            <span class="linecomment">;; Now update CAND+MRKER to reflect the replacement but with the text properties it had.</span>
            <span class="linecomment">;; (cdar NEWLIST) is the new cand+mrker.  Its car or caar is the replaced candidate.</span>
            <span class="linecomment">;; It is the first field of the multi-completion, in the latter case.</span>
...
(defun icicle-search-help (cand)
  ...
  (icicle-msg-maybe-in-minibuffer
   (let* ((icicle-whole-candidate-as-text-prop-p  t)
     ...
     (concat "<span class="quote">Buffer: `</span>" (buffer-name (marker-buffer marker))
...
<span class="linecomment">;;;###autoload (autoload 'icicle-keyword-list "icicles-cmd2.el")</span>
...
the resulting regexp is usable for `icicle-search'.</span>" <span class="linecomment">; Doc string</span>
  (lambda (name)                        <span class="linecomment">; Action function</span>
    (push name keywords)
  ...
  ((keywords                              nil) <span class="linecomment">; Bindings</span>
...
<span class="linecomment">;;;###autoload (autoload 'icicle-search-bookmark "icicles-cmd2.el")</span>
(icicle-define-command icicle-search-bookmark <span class="linecomment">; Command name</span>
  "<span class="quote">Search bookmarked text.
...
macro `icicle-define-search-bookmark-command'.</span>" <span class="linecomment">; Doc string</span>
  icicle-search-bookmark-action         <span class="linecomment">; Action function</span>
  ...
  ((enable-recursive-minibuffers             t) <span class="linecomment">; In case we read input, e.g. File changed on disk...</span>
   ...
   (prompt                                   "<span class="quote">Search bookmark: </span>")
   ...
   (bookmark-automatically-show-annotations  nil) <span class="linecomment">; Do not show annotations</span>
   (icicle-sort-orders-alist
  ...
  (progn                                <span class="linecomment">; First code</span>
    ...
    (when (featurep 'bookmark+)
      ...
      (dolist (map  '(minibuffer-local-must-match-map minibuffer-local-completion-map))
        (define-key (symbol-value map) "<span class="quote">\C-\M-b</span>" 'icicle-bookmark-non-file-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-d</span>" 'icicle-bookmark-dired-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-f</span>" 'icicle-bookmark-file-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-g</span>" 'icicle-bookmark-gnus-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-i</span>" 'icicle-bookmark-info-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-m</span>" 'icicle-bookmark-man-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-r</span>" 'icicle-bookmark-region-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-u</span>" 'icicle-bookmark-url-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-w</span>" 'icicle-bookmark-w3m-narrow)
        (define-key (symbol-value map) "<span class="quote">\C-\M-@</span>" 'icicle-bookmark-remote-file-narrow)
        (define-key (symbol-value map) [(control meta ?B)]
          'icicle-bookmark-bookmark-list-narrow) <span class="linecomment">; `C-M-B'</span>
        (define-key (symbol-value map) [(control meta ?F)]
          'icicle-bookmark-local-file-narrow) <span class="linecomment">; `C-M-F'</span>
        (define-key (symbol-value map) [(control meta ?K)]
          'icicle-bookmark-desktop-narrow)))) <span class="linecomment">; `C-M-K'</span>
...
(defun icicle-search-bookmark-action (bookmark-name)
  "<span class="quote">Action function for `icicle-search-bookmark'.</span>"
  (setq bookmark-name  (icicle-transform-multi-completion bookmark-name))
  (bookmark-jump-other-window bookmark-name)
  (setq mark-active  nil)               <span class="linecomment">; Unhighlight region, so you can see search hits etc.</span>
  (let ((icicle-show-Completions-initially-flag  t)
...
<span class="linecomment">;; Similar to `icicle-define-bookmark-command-1' in `icicles-cmd1.el'.  Could combine them.</span>
(defmacro icicle-define-search-bookmark-command (type &optional prompt &rest args)
  "<span class="quote">Define Icicles multi-command for searching bookmarks of type TYPE.
...
be loaded.</span>"
  `(icicle-define-command
    ,(intern (format "<span class="quote">icicle-search-%s-bookmark</span>" type)) <span class="linecomment">; Command name</span>
    ,(format "<span class="quote">Search %s bookmark text.
Like `icicle-search-bookmark', but with %s bookmarks only.
You need library `bookmark+.el' for this command.</span>" type type) <span class="linecomment">; Doc string</span>
    icicle-search-bookmark-action       <span class="linecomment">; Action function</span>
    prompt1 icicle-candidates-alist nil <span class="linecomment">; `completing-read' args</span>
    (not icicle-show-multi-completion-flag)
    nil (if (boundp 'bookmark-history) 'bookmark-history 'icicle-bookmark-history)
    nil nil
    ((IGNORED1                                 (unless (require 'bookmark+ nil t) <span class="linecomment">; Bindings</span>
...
command</span>")))
     ...
     (enable-recursive-minibuffers             t) <span class="linecomment">; In case we read input, e.g. File changed on...</span>
     (completion-ignore-case                   bookmark-completion-ignore-case)
     (prompt1                                  ,(or prompt (format "<span class="quote">Search %s bookmark: </span>" type)))
     (icicle-list-use-nth-parts                '(1))
     (icicle-candidate-properties-alist        (if (not icicle-show-multi-completion-flag)
                                                   nil
                                                 (if (facep 'file-name-shadow)
...
(icicle-define-search-bookmark-command "<span class="quote">all-tags</span>" nil (bmkp-read-tags-completing))
(icicle-define-search-bookmark-command "<span class="quote">all-tags-regexp</span>" nil (bmkp-read-tags-completing))
(icicle-define-search-bookmark-command "<span class="quote">autofile</span>")
(icicle-define-search-bookmark-command "<span class="quote">bookmark-list</span>")
(icicle-define-search-bookmark-command "<span class="quote">desktop</span>")
(icicle-define-search-bookmark-command "<span class="quote">dired</span>")
(icicle-define-search-bookmark-command "<span class="quote">file</span>")
(icicle-define-search-bookmark-command "<span class="quote">gnus</span>")
(icicle-define-search-bookmark-command "<span class="quote">info</span>")
(icicle-define-search-bookmark-command "<span class="quote">local-file</span>")
(icicle-define-search-bookmark-command "<span class="quote">man</span>")
(icicle-define-search-bookmark-command "<span class="quote">non-file</span>")
(icicle-define-search-bookmark-command "<span class="quote">region</span>" "<span class="quote">Search region: </span>")
(icicle-define-search-bookmark-command "<span class="quote">remote-file</span>")
(icicle-define-search-bookmark-command "<span class="quote">some-tags</span>" nil (bmkp-read-tags-completing))
(icicle-define-search-bookmark-command "<span class="quote">some-tags-regexp</span>" nil (bmkp-read-tags-completing))
(icicle-define-search-bookmark-command "<span class="quote">specific-buffers</span>" nil (icicle-bookmarked-buffer-list))
(icicle-define-search-bookmark-command "<span class="quote">specific-files</span>" nil (icicle-bookmarked-file-list))
(icicle-define-search-bookmark-command "<span class="quote">this-buffer</span>")
(icicle-define-search-bookmark-command "<span class="quote">url</span>")
(icicle-define-search-bookmark-command "<span class="quote">w3m</span>")

<span class="linecomment">;;; Same as `thgcmd-last-thing-type' in `thing-cmds.el'.</span>
(defvar icicle-last-thing-type (if (boundp 'thgcmd-last-thing-type) thgcmd-last-thing-type 'sexp)
  "<span class="quote">Type of thing last used by `icicle-next-visible-thing' (or previous).</span>")

<span class="linecomment">;;;###autoload</span>
(defun icicle-search-xml-element (beg end require-match where element)
  "<span class="quote">`icicle-search with XML ELEMENTs as search contexts.
...
Emacs, starting with Emacs 23.</span>"
  (interactive
   (let* ((where    (icicle-search-where-arg))
          (beg+end  (icicle-region-or-buffer-limits))
          (beg1     (car beg+end))
          (end1     (cadr beg+end))
          (elt      (read-string "<span class="quote">XML element (name regexp, no markup): </span>" nil 'regexp-history)))
     ...
     `(lambda (thg+bds)
       (and thg+bds
        (if (fboundp 'string-match-p)
            (string-match-p ,(format "<span class="quote">\\`\\s-*&lt;\\s-*%s\\s-*&gt;</span>" element) (car thg+bds))
          (string-match ,(format "<span class="quote">\\`\\s-*&lt;\\s-*%s\\s-*&gt;</span>" element) (car thg+bds))))))))

<span class="linecomment">;;;###autoload</span>
(defun icicle-search-thing (thing &optional beg end require-match where predicate)
  "<span class="quote">`icicle-search' with THINGs as search contexts.
...
6. Prior to Emacs 21 there is no possibility of ignoring comments.</span>"
  (interactive (icicle-search-thing-args))
  (unless beg (setq beg  (point-min)))
  (unless end (setq end  (point-max)))
  (unless (&lt; beg end) (setq beg  (prog1 end (setq end  beg)))) <span class="linecomment">; Ensure BEG is before END.</span>
  (setq icicle-search-context-level  0)
  (icicle-search beg end 'icicle-search-thing-scan require-match where thing predicate))

(defun icicle-search-thing-args ()
  "<span class="quote">Read and return interactive arguments for `icicle-search-thing'.</span>"
  (let* ((where    (icicle-search-where-arg))
         (beg+end  (icicle-region-or-buffer-limits))
         (beg1     (car beg+end))
         (end1     (cadr beg+end))
         (thing    (intern (completing-read "<span class="quote">Thing (type): </span>" (icicle-things-alist) nil nil nil nil
                                            (symbol-name icicle-last-thing-type)))))
    (when (and (eq thing 'comment)  icicle-ignore-comments-flag)
      (message "<span class="quote">Use `C-M-;' if you do not want to ignore comments</span>") (sit-for 2))
    `(,thing ,beg1 ,end1 ,(not icicle-show-multi-completion-flag) ,where)))

<span class="linecomment">;;; Same as `thgcmd-things-alist' in `thing-cmds.el'.</span>
(defun icicle-things-alist ()
  "<span class="quote">Alist of most thing types currently defined.
...
`point'.</span>"
  (let ((types  ()))
    ...
    (dolist (typ  '("<span class="quote">thing</span>" "<span class="quote">buffer</span>" "<span class="quote">point</span>")) <span class="linecomment">; Remove types that do not make sense.</span>
      (setq types (delete typ types)))
    (setq types  (sort types #'string-lessp))
    (mapcar #'list types)))

<span class="linecomment">;;; Same as `hide/show-comments' in `hide-comnt.el'.</span>
<span class="linecomment">;;;###autoload</span>
(defun icicle-hide/show-comments (&optional hide/show start end)
  "<span class="quote">Hide or show comments from START to END.
...
because it needs `comment-search-forward'.</span>"
  (interactive `(,(if current-prefix-arg 'show 'hide) ,@(icicle-region-or-buffer-limits)))
  (when (require 'newcomment nil t)     <span class="linecomment">; `comment-search-forward'</span>
      ...
      (unwind-protect
           (save-excursion
             ...
             (while (and (&lt; start end) (setq cbeg  (comment-search-forward end 'NOERROR)))
               (setq cend  (if (string= "<span class="quote"></span>" comment-end)
                               (1+ (line-end-position))
...
<span class="linecomment">;;; Same as `with-comments-hidden' in `hide-comnt.el', except doc here mentions `C-M-;'.</span>
(defmacro icicle-with-comments-hidden (start end &rest body)
  "<span class="quote">Evaluate the forms in BODY while comments are hidden from START to END.
...
comments.  Note that prior to Emacs 21, this never hides comments.</span>"
  (let ((result  (make-symbol "<span class="quote">result</span>"))
        (ostart  (make-symbol "<span class="quote">ostart</span>"))
        (oend    (make-symbol "<span class="quote">oend</span>")))
    `(let ((,ostart  ,start)
           (,oend    ,end)
           ,result)
      (unwind-protect
...
(defun icicle-search-thing-scan (buffer beg end thing &optional predicate)
  "<span class="quote">Scan BUFFER from BEG to END for things of type THING.
...
by `icicle-next-visible-thing-and-bounds'.</span>"
  (let ((add-bufname-p  (and buffer icicle-show-multi-completion-flag))
        (temp-list      ()))
    (unless buffer (setq buffer  (current-buffer)))
    (when (bufferp buffer)              <span class="linecomment">; Do nothing if BUFFER is not a buffer.</span>
      (with-current-buffer buffer
        (icicle-with-comments-hidden
         ...
         (condition-case icicle-search-thing-scan
             (save-excursion
               (goto-char beg)          <span class="linecomment">; `icicle-next-visible-thing-and-bounds' works with point.</span>
               (while (and beg  (&lt; beg end))
                 (while (and (&lt; beg end) (icicle-invisible-p beg)) <span class="linecomment">; Skip invisible, overlay or text.</span>
                 ...
                 (let* ((thg+bnds    (icicle-next-visible-thing-and-bounds thing beg end))
                   ...
                   (when (and thg+bnds (or (not predicate) (funcall predicate thg+bnds)))
                     (icicle-candidate-short-help
                      (concat (and add-bufname-p
                                   (format "<span class="quote">Buffer: `%s', </span>"
                                           (buffer-name (marker-buffer end-marker))))
                              (format "<span class="quote">Bounds: (%d, %d), Length: %d</span>"
                   ...
                   (if thg-end
                     ...
                     (unless (icicle-invisible-p beg)
                       (setq beg  end))))) <span class="linecomment">; If not invisible then no more things, so skip to END.</span>
...
<span class="linecomment">;; Same as `thgcmd-invisible-p' in `thing-cmds.el'.</span>
(defun icicle-invisible-p (position)
  "<span class="quote">Return non-nil if the character at POSITION is invisible.</span>"
  (if (fboundp 'invisible-p)            <span class="linecomment">; Emacs 22+</span>
      (invisible-p position)
    (let ((prop  (get-char-property position 'invisible))) <span class="linecomment">; Overlay or text property.</span>
...
(defun icicle-next-visible-thing-and-bounds (thing start end)
  "<span class="quote">Return the next visible THING and its bounds.
...
<span class="linecomment">;;; Simple version of `previous-visible-thing' from `thing-cmds.el'.</span>
<span class="linecomment">;;;###autoload</span>
(defun icicle-previous-visible-thing (thing start &optional end)
  "<span class="quote">Same as `icicle-next-visible-thing', except it moves backward.</span>"
  (interactive
   (list (or (and (memq last-command '(icicle-next-visible-thing icicle-previous-visible-thing))
                  icicle-last-thing-type)
             (prog1 (intern (completing-read "<span class="quote">Thing (type): </span>" (icicle-things-alist) nil nil nil nil
                                             (symbol-name icicle-last-thing-type)))))
         (point)
...
<span class="linecomment">;;; Simple version of `next-visible-thing' from `thing-cmds.el'.</span>
<span class="linecomment">;;;###autoload</span>
(defun icicle-next-visible-thing (thing &optional start end backward)
  "<span class="quote">Go to the next visible THING.
...
Return (THING THING-START . THING-END), with THING-START and THING-END
the bounds of THING.  Return nil if no such THING is found.</span>"
  (interactive
   (list (or (and (memq last-command '(icicle-next-visible-thing icicle-previous-visible-thing))
                  icicle-last-thing-type)
             (prog1 (intern (completing-read "<span class="quote">Thing (type): </span>" (icicle-things-alist) nil nil nil nil
...
<span class="linecomment">;;; Same as `next-visible-thing-1' in `thing-cmds.el'.</span>
(if (fboundp 'next-visible-thing-1)
  ...
  (defun icicle-next-visible-thing-1 (thing start end backward)
    "<span class="quote">Helper for `icicle-next-visible-thing'.  Get thing past point.</span>"
    (let ((thg+bds  (icicle-next-visible-thing-2 thing start end backward)))
      (if (not thg+bds)
          nil
        <span class="linecomment">;; $$$$$$ Which is better, &gt; or &gt;=, &lt; or &lt;=, for the comparisons?</span>
        <span class="linecomment">;; $$$$$$ (while (and thg+bds</span>
        <span class="linecomment">;;                    (if backward  (&gt; (cddr thg+bds) (point)) (&lt;= (cadr thg+bds) (point))))</span>
...
<span class="linecomment">;;; Same as `next-visible-thing-2' in `thing-cmds.el'.</span>
(if (fboundp 'next-visible-thing-2)
  ...
  (defun icicle-next-visible-thing-2 (thing start end &optional backward)
    "<span class="quote">Helper for `icicle-next-visible-thing-1'.  Thing might not be past START.</span>"
    (and (not (= start end))
         (save-excursion
           (let ((bounds  nil))
             <span class="linecomment">;; If BACKWARD, swap START and END.</span>
             (cond ((&lt; start end) (when   backward (setq start  (prog1 end (setq end  start)))))
                   ((&gt; start end) (unless backward (setq start  (prog1 end (setq end  start))))))
             (catch 'icicle-next-visible-thing-2
               (while (if backward (&gt; start end) (&lt; start end))
                 (goto-char start)
                 <span class="linecomment">;; Skip invisible text.</span>
                 (when (and (if backward (&gt; start end) (&lt; start end)) (icicle-invisible-p start))
                   (setq start  (if (get-text-property start 'invisible) <span class="linecomment">; Text prop.</span>
                                    (if backward
                                        (previous-single-property-change start 'invisible nil end)
                                      (next-single-property-change start 'invisible nil end))
                                  (if backward <span class="linecomment">; Overlay prop.</span>
                                      (previous-overlay-change start)
                                    (next-overlay-change start))))
                   (goto-char start))
                 (when (and (setq bounds  (bounds-of-thing-at-point thing))
                            (not (equal (car bounds) (cdr bounds)))) <span class="linecomment">; Not an empty thing, "".</span>
...
text properties, or both, respectively.</span>"
  (cond ((and (consp where) (bufferp (car where))) <span class="linecomment">; List of buffers - search buffers.</span>
        ...
        ((consp where)                  <span class="linecomment">; Search bookmarked regions.</span>
         (unless (require 'bookmark+ nil t) (error "<span class="quote">This requires library `bookmark+.el'</span>"))
              ...
              (while (and beg (&lt; beg end))
                ...
                (let* ((hit-string  (buffer-substring-no-properties beg zone-end))
                  ...
                  (when (or (not predicate)
                    ...
                    (icicle-candidate-short-help
                     (concat (and add-bufname-p
                                  (format "<span class="quote">Buffer: `%s', </span>" (buffer-name (marker-buffer end-marker))))
                             (format "<span class="quote">Position: %d, Length: %d</span>"
                                     (marker-position end-marker) (length hit-string)))
                     hit-string)
                    (push (cons (if add-bufname-p
...
<span class="linecomment">;; Same as `thgcmd-next-single-char-property-change' in `thing-cmds.el'.</span>
...
<span class="linecomment">;; Same as `thgcmd-previous-single-char-property-change' in `thing-cmds.el'.</span>
(if (fboundp 'previous-single-char-property-change)
  ...
  (defun icicle-previous-single-char-property-change (position prop &optional object limit)
    "<span class="quote">Position of previous change of PROP for text property or overlay change.
...
(defun icicle-search-bookmarks-together (scan-fn-or-regexp require-match &rest args)
  "<span class="quote">Search bookmarked regions (together).
...
searches the bookmarked regions you choose one at a time.</span>"
...
(defun icicle-search-bookmark-list-marked (scan-fn-or-regexp require-match &rest args)
  "<span class="quote">Search the files of the marked bookmarks in `*Bookmark List*'.
Arguments are the same as for `icicle-search', but without arguments
BEG, END, and WHERE.</span>"
  (interactive `(,(if icicle-search-whole-word-flag
                      (icicle-search-read-word)
  ...
  (let ((fg (face-foreground        'icicle-search-main-regexp-others))
    ...
    (unwind-protect
         (progn (set-face-foreground 'icicle-search-main-regexp-others nil)
                ...
                (icicle-search beg end "<span class="quote">.*</span>" (not icicle-show-multi-completion-flag) buffers))
      (when icicle-search-cleanup-flag (icicle-search-highlight-cleanup))
...
(defun icicle-search-sentences (beg end &optional buffers)
  "<span class="quote">`icicle-search' with sentences as contexts.
...
`icicle-search'.</span>"
  ...
  (let ((fg (face-foreground        'icicle-search-main-regexp-others))
    ...
    (unwind-protect
         (progn (set-face-foreground 'icicle-search-main-regexp-others nil)
                (set-face-background 'icicle-search-main-regexp-others nil)
                (icicle-search beg end (concat "<span class="quote">[A-Z][^.?!]+[.?!]</span>")
...
(defun icicle-search-paragraphs (beg end &optional buffers)
  "<span class="quote">`icicle-search' with paragraphs as contexts.
...
`icicle-search'.</span>"
  ...
  (let ((fg (face-foreground        'icicle-search-main-regexp-others))
    ...
    (unwind-protect
         (progn (set-face-foreground 'icicle-search-main-regexp-others nil)
                (set-face-background 'icicle-search-main-regexp-others nil)
                (icicle-search beg end "<span class="quote">\\(.+\n\\)+</span>"
                               (not icicle-show-multi-completion-flag) buffers))
      (when icicle-search-cleanup-flag (icicle-search-highlight-cleanup))
      (set-face-foreground 'icicle-search-main-regexp-others fg)
      (set-face-background 'icicle-search-main-regexp-others bg))))
...
(defun icicle-search-pages (beg end &optional buffers)
  "<span class="quote">`icicle-search' with pages as contexts.
...
`icicle-search'.</span>"
  ...
  (let ((fg (face-foreground        'icicle-search-main-regexp-others))
    ...
    (unwind-protect
         (progn (set-face-foreground 'icicle-search-main-regexp-others nil)
                (set-face-background 'icicle-search-main-regexp-others nil)
                (icicle-search beg end "<span class="quote">\\([^\f]*[\f]\\|[^\f]+$\\)</span>"
                               (not icicle-show-multi-completion-flag) buffers))
      (when icicle-search-cleanup-flag (icicle-search-highlight-cleanup))
      (set-face-foreground 'icicle-search-main-regexp-others fg)
      (set-face-background 'icicle-search-main-regexp-others bg))))
...
`icicle-search'.</span>"
  <span class="linecomment">;; $$$$$$ It would be good to somehow rebind C-next etc. to just what next etc. does.</span>
  (interactive (icicle-region-or-buffer-limits))
  ...
  (let ((orig-search-hook           icicle-search-hook)
    ...
    (unwind-protect
         (icicle-search beg end
                        (concat comint-prompt-regexp "<span class="quote">\\S-.*</span>") nil) <span class="linecomment">; Match not required (edit).</span>
...
<span class="linecomment">;;;###autoload (autoload 'icicle-comint-command "icicles-cmd2.el")</span>
...
See also \\&lt;comint-mode-map&gt;\\[icicle-comint-search] for another way to reuse commands.</span>" <span class="linecomment">; Doc string</span>
  insert                                <span class="linecomment">; Action function</span>
...
`icicle-search'.</span>"
  ...
  (let ((icicle-transform-function    (if (interactive-p) nil icicle-transform-function))
        ...
        (next-error-highlight
         <span class="linecomment">;; Highlight indefinitely.  `until-move' should be part of Emacs (patch sent), but it's not.</span>
...
If `crosshairs.el' is loaded, then the target position is highlighted.</span>"
  ...
  (save-excursion
    (save-restriction
      (let ((inhibit-field-text-motion  t)) <span class="linecomment">; Just to be sure, for `end-of-line'.</span>
...
variable.</span>"
  ...
  (let* ((enable-recursive-minibuffers  t)
          ...
          (if askp
              (let ((icicle-candidate-alt-action-fn
                    ...
                    (icicle-all-candidates-list-alt-action-fn
                     (or icicle-all-candidates-list-alt-action-fn
                         (icicle-alt-act-fn-for-type "<span class="quote">variable</span>"))))
                (intern (completing-read "<span class="quote">Variable: </span>" obarray nil nil nil
                                         (if (boundp 'variable-name-history)
                                             'variable-name-history
                                           'icicle-variable-name-history)
         ...
         (text                          (icicle-completing-read-history
                                         (format "<span class="quote">Text to save in `%s': </span>" var))))
    (set var text)))
...
(defun icicle-object-action (&optional type)
  "<span class="quote">Act on an object of type TYPE (a symbol).
  ...
  (let* ((anything-loaded-p         (and (&gt; emacs-major-version 21)
         ...
         (typ
          (or type
              (let ((icicle-show-Completions-initially-flag  t))
                (intern
                 (completing-read "<span class="quote">What (type): </span>"
         ...
         (icicle-candidate-alt-action-fn <span class="linecomment">; For "how".</span>
...
(when (&gt; emacs-major-version 21)
  (defun icicle-get-anything-actions-for-type (type)
    "<span class="quote">Set and return `icicle-candidates-alist' of actions for type TYPE.
        ...
        (when (or (eq type (assoc-default 'type source))
          ...
          (dolist (action  this-source-actions)
            (unless (member action all-sources-actions)
              (setq faced-act  (copy-sequence (car action))) <span class="linecomment">; Highlight Anything action.</span>
...
(when (&gt; emacs-major-version 21)
  (defun icicle-get-anything-default-actions-for-type (type)
    ...
    (let ((all-sources-actions  ())
      ...
      (setq icicle-candidates-alist
            (sort all-sources-actions   <span class="linecomment">; Must sort, or `icicle-candidate-nb' will be wrong.</span>
                  #'(lambda (a1 a2) (funcall icicle-sort-comparer (car a1) (car a2))))))))

(defun icicle-choose-candidate-of-type (type)
  "<span class="quote">Read an object of type TYPE (a symbol) with completion, and return it.
...
filtering:
 ...
 `icicle-buffer-sort'                 - Sort function for candidates</span>"
  (let ((icicle-orig-window  (selected-window))) <span class="linecomment">; For alternative actions.</span>
    (case type
      (buffer
       (let* ((completion-ignore-case
              ...
              (icicle-delete-candidate-object          'icicle-kill-a-buffer) <span class="linecomment">; `S-delete' kills buf</span>
              ...
              <span class="linecomment">;; Put `icicle-buffer-sort' first.  If already in list, move it, else add it, to start.</span>
              (icicle-sort-orders-alist
                      ...
                      (if icicle-buffer-sort
                          (let ((already-there  (rassq icicle-buffer-sort icicle--temp-orders)))
                            (if already-there
                              ...
                              (cons `("<span class="quote">by `icicle-buffer-sort'</span>" . ,icicle-buffer-sort)
                                    icicle--temp-orders)))
                        icicle--temp-orders)))
              (icicle-candidate-alt-action-fn
      ...
      (color (icicle-read-color 1))     <span class="linecomment">; Use the color name (only).</span>
      (command (let ((icicle-must-pass-after-match-predicate  #'(lambda (s) (commandp (intern s))))
                     ...
                     (icicle-all-candidates-list-alt-action-fn
                      (or icicle-all-candidates-list-alt-action-fn
                          (icicle-alt-act-fn-for-type "<span class="quote">command</span>"))))
                 (intern (completing-read "<span class="quote">Which (command): </span>" obarray))))
      (face (let ((icicle-candidate-alt-action-fn
                  ...
                  (icicle-all-candidates-list-alt-action-fn
                   (or icicle-all-candidates-list-alt-action-fn
                       (icicle-alt-act-fn-for-type "<span class="quote">face</span>"))))
              (intern (completing-read "<span class="quote">Which (face): </span>" (mapcar #'(lambda (x) (list (format "<span class="quote">%s</span>" x)))
                                                                (face-list))))))
      (file (let ((icicle-candidate-alt-action-fn
                   (or icicle-candidate-alt-action-fn
                       (icicle-alt-act-fn-for-type "<span class="quote">file</span>")))
                  (icicle-all-candidates-list-alt-action-fn
                   (or icicle-all-candidates-list-alt-action-fn
                       (icicle-alt-act-fn-for-type "<span class="quote">file</span>")))
                  (icicle-delete-candidate-object  'icicle-delete-file-or-directory)) <span class="linecomment">; `S-delete'</span>
      ...
      (frame (let ((frame-alist  (icicle-make-frame-alist))
                   (icicle-candidate-alt-action-fn
                    (or icicle-candidate-alt-action-fn
                        (icicle-alt-act-fn-for-type "<span class="quote">frame</span>")))
                   (icicle-all-candidates-list-alt-action-fn
                    (or icicle-all-candidates-list-alt-action-fn
                        (icicle-alt-act-fn-for-type "<span class="quote">frame</span>"))))
      ...
      (function (let ((icicle-must-pass-after-match-predicate  #'(lambda (s) (fboundp (intern s))))
                      ...
                      (icicle-all-candidates-list-alt-action-fn
                       (or icicle-all-candidates-list-alt-action-fn
                           (icicle-alt-act-fn-for-type "<span class="quote">function</span>"))))
                  (intern (completing-read "<span class="quote">Which (function): </span>" obarray))))
      (option (let ((icicle-must-pass-after-match-predicate  #'(lambda (s)
                                                                 (user-variable-p (intern s))))
                    (icicle-candidate-alt-action-fn
                     (or icicle-candidate-alt-action-fn
                         (icicle-alt-act-fn-for-type "<span class="quote">option</span>")))
                    (icicle-all-candidates-list-alt-action-fn
                     (or icicle-all-candidates-list-alt-action-fn
                         (icicle-alt-act-fn-for-type "<span class="quote">option</span>"))))
                (intern (completing-read "<span class="quote">Which (user option): </span>" obarray))))
      (process (let ((icicle-candidate-alt-action-fn
                      (or icicle-candidate-alt-action-fn
                          (icicle-alt-act-fn-for-type "<span class="quote">process</span>")))
                     (icicle-all-candidates-list-alt-action-fn
                      (or icicle-all-candidates-list-alt-action-fn
                          (icicle-alt-act-fn-for-type "<span class="quote">process</span>"))))
                 (get-process
      ...
      (symbol (let ((icicle-candidate-alt-action-fn
                    ...
                    (icicle-all-candidates-list-alt-action-fn
                     (or icicle-all-candidates-list-alt-action-fn
                         (icicle-alt-act-fn-for-type "<span class="quote">symbol</span>"))))
                (intern (completing-read "<span class="quote">Which (symbol): </span>" obarray))))
      (variable (let ((icicle-must-pass-after-match-predicate  #'(lambda (s) (boundp (intern s))))
                      ...
                      (icicle-all-candidates-list-alt-action-fn
                       (or icicle-all-candidates-list-alt-action-fn
                           (icicle-alt-act-fn-for-type "<span class="quote">variable</span>"))))
                  (intern (completing-read "<span class="quote">Which (variable): </span>" obarray))))
      (window (let ((icicle-candidate-alt-action-fn
                     (or icicle-candidate-alt-action-fn
                         (icicle-alt-act-fn-for-type "<span class="quote">window</span>")))
                    (icicle-all-candidates-list-alt-action-fn
                     (or icicle-all-candidates-list-alt-action-fn
                         (icicle-alt-act-fn-for-type "<span class="quote">window</span>")))
                    (buffers  ()))
  ...
  (symbol-value
   (let ((icicle-orig-window                      (selected-window))
         ...
         (icicle-candidate-alt-action-fn          (or icicle-candidate-alt-action-fn
                                                      (icicle-alt-act-fn-for-type "<span class="quote">variable</span>")))
         (icicle-all-candidates-list-alt-action-fn
          (or icicle-all-candidates-list-alt-action-fn (icicle-alt-act-fn-for-type "<span class="quote">variable</span>"))))
     (intern (completing-read (format "<span class="quote">Which (%s value of variable): </span>" pred) obarray)))))

(defvar icicle-key-prefix nil
  "<span class="quote">A prefix key.</span>")

(defvar icicle-key-prefix-2 nil
  "<span class="quote">A prefix key.</span>")

(defvar icicle-active-map nil
  "<span class="quote">An active keymap.</span>")

(defvar icicle-orig-buff-key-complete nil
  "<span class="quote">Current buffer when you invoked `icicle-complete-keys'.</span>")

(defvar icicle-orig-extra-cands ()
  "<span class="quote">Value of `icicle-extra-candidates', before command.</span>")

(defvar icicle-orig-show-initially-flag nil
  "<span class="quote">Value of `icicle-show-Completions-initially-flag', before command.</span>")

(defvar icicle-orig-sort-orders-alist ()
  "<span class="quote">Value of `icicle-sort-orders-alist', before command.</span>")

(defvar icicle-orig-win-key-complete nil
  "<span class="quote">Selected window when you invoked `icicle-complete-keys'.</span>")

(defvar icicle-this-cmd-keys ()
  "<span class="quote">Value of `this-command-keys-vector' at some point in key completion.</span>")
...
`icicle-mode'.</span>"
    ...
    (let* ((icicle-transform-function               'icicle-remove-duplicates)
           (icicle-orig-sort-orders-alist           icicle-sort-orders-alist) <span class="linecomment">; For recursive use.</span>
           ...
           (icicle-sort-orders-alist
            '(("<span class="quote">by key name, local bindings first</span>" . icicle-local-keys-first-p)
           ...
           (icicle-hist-cands-no-highlight          '("<span class="quote">..</span>")))
  ...
  (defun icicle-complete-keys-1 (prefix) <span class="linecomment">; PREFIX is a free var in `icicle-complete-keys-action'.</span>
    ...
    <span class="linecomment">;; `icicle-orig-extra-cands' is free in `icicle-complete-keys-action'.</span>
    (let ((icicle-orig-extra-cands  icicle-extra-candidates)
      ...
      (unwind-protect
           (progn
             ...
             (let* ((icicle-this-cmd-keys <span class="linecomment">; For error report - e.g. mouse command.</span>
                    ...
                    (prompt  (concat "<span class="quote">Complete keys</span>"
                                     (and (not (string= "<span class="quote"></span>" icicle-key-prefix-description))
                                          (concat "<span class="quote"> </span>" icicle-key-prefix-description))
                                     "<span class="quote">: </span>")))
  ...
  <span class="linecomment">;; Free vars here:</span>
  <span class="linecomment">;; `icicle-orig-buff-key-complete', `icicle-orig-win-key-complete', bound in `icicle-complete-keys'.</span>
  <span class="linecomment">;; `icicle-orig-extra-cands', `icicle-this-cmd-keys', `icicle-key-prefix',</span>
  <span class="linecomment">;; bound in `icicle-complete-keys-1'.</span>
             ...
             (cond ((string= "<span class="quote">..</span>" cmd-name) <span class="linecomment">; Go back up to parent prefix.</span>
                   ...
                   (t
                    (setq this-command             binding
                          ...
                          icicle-extra-candidates  icicle-orig-extra-cands) <span class="linecomment">; Restore it.</span>
                    ...
                    (condition-case try-command <span class="linecomment">; Bind so vanilla context when invoke chosen cmd.</span>
                        (let ((icicle-candidate-action-fn              nil)
  ...
  (defun icicle-keys+cmds-w-prefix (prefix)
    ...
    (let ((prefix-map           nil)
      ...
      (dolist (icicle-active-map  (current-active-maps t))
        ...
        <span class="linecomment">;; NOTE: `icicle-add-key+cmd' uses `icicle-key-prefix-2' and `icicle-active-map' as free vars.</span>
        (when (keymapp prefix-map) (map-keymap #'icicle-add-key+cmd prefix-map)))
      (unless (equal [] prefix)
        (push (list (intern (propertize "<span class="quote">..</span>" 'face 'icicle-multi-command-completion)))
              icicle-complete-keys-alist))
      icicle-complete-keys-alist))

  <span class="linecomment">;; Free vars here: `icicle-key-prefix-2' and `icicle-active-map' are bound in</span>
  ...
  (defun icicle-add-key+cmd (event binding)
    ...
    <span class="linecomment">;; `icicle-key-prefix-2' and `icicle-active-map' are free here, bound in</span>
    <span class="linecomment">;; `icicle-keys+cmds-w-prefix'.</span>
...
(when (fboundp 'define-minor-mode)      <span class="linecomment">; Emacs 21+ ------------</span>
  (eval '(define-minor-mode icicle-ido-like-mode
          "<span class="quote">Ido-like mode for use with Icicles.
...
dynamically for the mode, use `icicle-ido-like-mode-hook'.  E.g.:
 ...
 (add-hook 'icicle-ido-like-mode-hook
           (lambda () (setq icicle-default-value
                       (if icicle-ido-like-mode t 'insert-end))))</span>"
...
(when (and (fboundp 'read-color) (not (fboundp 'old-read-color))) <span class="linecomment">; Exists starting with Emacs 23.</span>
  ...
  (let (color)
    (if (consp arg)                     <span class="linecomment">; Plain `C-u': complete against color name only,</span>
      ...
      (let ((icicle-list-use-nth-parts
             (or (and arg (if (&lt; arg 2) '(1) '(2))) <span class="linecomment">; 1 or 2, by program or via `C-1' or `C-2'.</span>
        ...
        <span class="linecomment">;; Copy the prompt string because `icicle-color-completion-setup' puts a text prop on it.</span>
        <span class="linecomment">;; Use `icicle-prompt' from now on, since that's what `icicle-color-completion-setup' sets up.</span>
        (setq icicle-prompt  (copy-sequence (or prompt "<span class="quote">Color: </span>")))
        ...
        (setq icicle-proxy-candidates
              ...
              color  (icicle-transform-multi-completion
                      (let ((icicle-orig-window  (selected-window))
                            (icicle-candidate-alt-action-fn
                             (or icicle-candidate-alt-action-fn
                                 (icicle-alt-act-fn-for-type "<span class="quote">color</span>")))
                            (icicle-all-candidates-list-alt-action-fn
                             (or icicle-all-candidates-list-alt-action-fn
                                 (icicle-alt-act-fn-for-type "<span class="quote">color</span>"))))
...
(defun icicle-set-TAB-methods-for-command (command methods &optional arg msgp)
  "<span class="quote">Set the possible TAB completion methods for COMMAND.
...
See also `icicle-set-S-TAB-methods-for-command'.</span>"
...
(defun icicle-set-S-TAB-methods-for-command (command methods &optional arg msgp)
  "<span class="quote">Set the possible S-TAB completion methods for COMMAND.
This works by advising COMMAND.
With a negative prefix arg, restore the original, unadvised behavior.
With a non-negative prefix arg, advise but do not enable the advice.
 You can later enable the advice and activate it, using
...
See also `icicle-set-TAB-methods-for-command'.</span>"
...
(defun icicle-read-args-for-set-completion-methods (var)
  "<span class="quote">Read arguments for `icicle-set-(S-)TAB-methods-for-command'.
VAR is symbol `icicle-(S-)TAB-completion-methods(-alist)'.</span>"
  (let ((command  (intern (let ((icicle-must-pass-after-match-predicate
                                 #'(lambda (c) (commandp (intern c)))))
                            (completing-read "<span class="quote">Command: </span>" obarray nil t))))
        (methods  ()))
    (unless (&lt; (prefix-numeric-value current-prefix-arg) 0)
      (let ((prompt  (if (eq var 'icicle-TAB-completion-methods) "<span class="quote">TAB methods: </span>" "<span class="quote">S-TAB methods: </span>"))
            (cmeths  (symbol-value var))
            meth)
        (setq cmeths  (if (consp (car cmeths))
                          cmeths
                        (mapcar (lambda (m) (list (symbol-name m))) cmeths)))
        (while (not (string= "<span class="quote"></span>" (setq meth  (completing-read prompt cmeths nil t))))
...
(defun icicle-set-completion-methods-for-command (command methods var arg msgp)
  "<span class="quote">Set the possible completion methods for COMMAND.
This works by advising COMMAND.
...
Null ARG means advise and enable.</span>"
  (let ((type  (if (eq var 'icicle-TAB-completion-methods) "<span class="quote">TAB methods</span>" "<span class="quote">S-TAB methods</span>")))
    (cond ((&lt; (prefix-numeric-value arg) 0)
           (condition-case nil
               (ad-remove-advice command 'around var)
             (error nil))
           (ad-activate command)        <span class="linecomment">; This restores original definition unless otherwise advised.</span>
           (when msgp (message "<span class="quote">`%s' now uses default %s</span>" command type)))
          (t
           (ad-add-advice command `(,var
                          ...
                          'around 'first)
           (ad-activate command)
           (when msgp (message "<span class="quote">`%s' %s: %s</span>" command type
...
<span class="linecomment">;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;</span>
<span class="linecomment">;;; icicles-cmd2.el ends here</span></span></pre></div><div class="wrapper close"></div></div><div class="footer"><hr /><span class="gotobar bar"><a class="local" href="http://www.emacswiki.org/emacs/SiteMap">SiteMap</a> <a class="local" href="http://www.emacswiki.org/emacs/Search">Search</a> <a class="local" href="http://www.emacswiki.org/emacs/ElispArea">ElispArea</a> <a class="local" href="http://www.emacswiki.org/emacs/HowTo">HowTo</a> <a class="local" href="http://www.emacswiki.org/emacs/RecentChanges">RecentChanges</a> <a class="local" href="http://www.emacswiki.org/emacs/News">News</a> <a class="local" href="http://www.emacswiki.org/emacs/Problems">Problems</a> <a class="local" href="http://www.emacswiki.org/emacs/Suggestions">Suggestions</a> </span><span class="translation bar"><br />  <a class="translation new" rel="nofollow" href="http://www.emacswiki.org/emacs?action=translate;id=icicles-cmd2.el;missing=de_es_fr_it_ja_ko_pt_ru_se_zh">Add Translation</a></span><span class="edit bar"><br /> <a class="edit" accesskey="e" title="Click to edit this page" rel="nofollow" href="http://www.emacswiki.org/emacs?action=edit;id=icicles-cmd2.el">Edit this page</a> <a class="history" rel="nofollow" href="http://www.emacswiki.org/emacs?action=history;id=icicles-cmd2.el">View other revisions</a> <a class="admin" rel="nofollow" href="http://www.emacswiki.org/emacs?action=admin;id=icicles-cmd2.el">Administration</a></span><span class="time"><br /> Last edited 2011-06-03 22:51 UTC by <a class="author" title="from 148.87.67.196" href="http://www.emacswiki.org/emacs/DrewAdams">DrewAdams</a> <a class="diff" rel="nofollow" href="http://www.emacswiki.org/emacs?action=browse;diff=2;id=icicles-cmd2.el">(diff)</a></span><div style="float:right; margin-left:1ex;">
